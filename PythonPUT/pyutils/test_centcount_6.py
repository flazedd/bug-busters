...
def test_case_10():
    ...
    var_3.__repr__(var_3)


@pytest.mark.xfail(strict=True)
def test_case_11():
    str_0 = 'Pq/A"pQA?g6I[COZJ[R3'
    none_type_0 = None
...
def test_case_12():
    ...
    var_4 = cent_count_0.__gt__(var_1)
...
def test_case_13():
    bytes_0 = b"\x88]\xb9Sm\x9a6"
    none_type_0 = None
    with pytest.raises(ValueError):
        module_0.CentCount(bytes_0, strict_mode=none_type_0)
...
def test_case_16():
    ...
    var_3 = cent_count_0.__le__(cent_count_0)
    assert var_3 is True
    var_4 = cent_count_0.__mul__(var_3)
    assert (
    ...
    var_6 = var_5.__le__(var_3)
    assert var_6 is True
    var_7 = var_4.__sub__(cent_count_0)
    assert (
    ...
    var_12 = var_3.__ne__(cent_count_0)
    var_9.__setitem__(var_5, var_7)
...
def test_case_21():
    ...
    var_6 = cent_count_0.__mul__(var_5)
    assert (
    ...
    var_7 = cent_count_0.__add__(var_4)
    assert (
        f"{type(var_7).__module__}.{type(var_7).__qualname__}" == "centcount.CentCount"
    )
    assert var_7.strict_mode is False
...
def test_case_22():
    ...
    assert var_1.centcount == 0
    assert var_1.currency == "USD"
    var_2 = var_0.__ne__(cent_count_0)
    ...
    with pytest.raises(AttributeError):
        var_0.__getattr__(cent_count_0, cent_count_0)
...
def test_case_24():
    ...
    var_6 = cent_count_0.__mul__(var_2)
    assert (
        f"{type(var_6).__module__}.{type(var_6).__qualname__}" == "centcount.CentCount"
    )
    assert var_6.strict_mode is False
    assert var_6.centcount == 0
    assert var_6.currency == "USD"
    var_7 = cent_count_0.__add__(var_5)
    assert (
        f"{type(var_7).__module__}.{type(var_7).__qualname__}" == "centcount.CentCount"
    )
    assert var_7.strict_mode is False
    ...
    assert var_10.strict_mode is False
    assert var_10.centcount == -58581
    assert var_10.currency == "USD"
    var_11 = var_8.__pos__()
    assert var_11 == 0
    var_12 = var_5.__eq__(cent_count_0)
    var_13 = var_1.__neg__()
    assert var_13 == 0
    var_14 = var_7.__dir__()
    var_15 = var_8.__ne__(var_14)
    var_12.__setitem__(var_13, cent_count_0)
...
def test_case_25():
    ...
    none_type_0 = None
    cent_count_0 = module_0.CentCount(currency=none_type_0, strict_mode=error_0)
    assert (
        f"{type(cent_count_0).__module__}.{type(cent_count_0).__qualname__}"
        == "centcount.CentCount"
    )
...
def test_case_26():
    ...
    assert var_6 == -1
    var_7 = cent_count_0.__sub__(var_5)
    assert (
        f"{type(var_7).__module__}.{type(var_7).__qualname__}" == "centcount.CentCount"
    )
    assert var_7.strict_mode is False
    ...
    assert var_7.currency == "USD"
    var_8 = var_2.__mul__(enum_dict_0)
    var_9 = var_2.__eq__(cent_count_0)
    int_0 = var_9.__hash__()
    assert int_0 == -9223363241765397890
    var_10 = var_7.__neg__()
    assert (
        f"{type(var_10).__module__}.{type(var_10).__qualname__}"
        == "centcount.CentCount"
    )
...
def test_case_28():
    ...
    var_5 = cent_count_0.__le__(cent_count_0)
    assert var_5 is True
    var_6 = cent_count_0.__float__()
    assert var_6 == pytest.approx(0.0, abs=0.01, rel=0.01)
    var_7 = cent_count_0.__rsub__(var_5)
    assert (
        f"{type(var_7).__module__}.{type(var_7).__qualname__}" == "centcount.CentCount"
    )
    assert var_7.strict_mode is False
    assert var_7.centcount == 1
    assert var_7.currency == "USD"
    var_8 = cent_count_0.__mul__(var_5)
    assert (
        f"{type(var_8).__module__}.{type(var_8).__qualname__}" == "centcount.CentCount"
    )
    assert var_8.strict_mode is False
    assert var_8.centcount == 0
    assert var_8.currency == "USD"
    var_9 = cent_count_0.__add__(var_3)
    assert (
        f"{type(var_9).__module__}.{type(var_9).__qualname__}" == "centcount.CentCount"
    )
    assert var_9.strict_mode is False
    assert var_9.centcount == 0
    assert var_9.currency == "USD"
    var_10 = var_9.__le__(var_5)
    assert var_10 is True
    var_11 = var_7.__ge__(cent_count_0)
    assert var_11 is True
    var_12 = var_8.__sub__(var_3)
    assert (
...
def test_case_29():
    ...
    assert var_4.centcount == 0
    assert var_4.currency == "USD"
    var_5 = cent_count_0.__mul__(var_2)
    assert (
        f"{type(var_5).__module__}.{type(var_5).__qualname__}" == "centcount.CentCount"
    )
    assert var_5.strict_mode is False
    assert var_5.centcount == 0
    assert var_5.currency == "USD"
    var_6 = cent_count_0.__add__(var_2)
    assert (
        f"{type(var_6).__module__}.{type(var_6).__qualname__}" == "centcount.CentCount"
    )
    assert var_6.strict_mode is False
    ...
    var_7 = var_3.__int__()
    assert var_7 == 0
    var_8 = var_6.__le__(cent_count_0)
    assert var_8 is False
    var_9 = var_5.__sub__(var_2)
    assert (
        f"{type(var_9).__module__}.{type(var_9).__qualname__}" == "centcount.CentCount"
    )
    assert var_9.strict_mode is False
    ...
    assert var_12.centcount == 0
    assert var_12.currency == "USD"
    var_13 = var_5.__float__()
    assert var_13 == pytest.approx(0.0, abs=0.01, rel=0.01)
    var_14 = var_10.__ne__(cent_count_0)
    assert var_14 is False
    var_5.__setitem__(var_11, var_3)
...
def test_case_30():
    ...
    var_4 = cent_count_0.__repr__()
    assert var_4 == "0.00 USD"
    var_5 = cent_count_0.__ne__(var_0)
    assert var_5 is False
    var_6 = module_0.CentCount(currency=var_4, strict_mode=var_1)
    assert (
        f"{type(var_6).__module__}.{type(var_6).__qualname__}" == "centcount.CentCount"
    )
    assert var_6.strict_mode is False
    assert var_6.centcount == 0
    assert var_6.currency == "0.00 USD"
    var_7 = cent_count_0.__add__(var_4)
    assert (
        f"{type(var_7).__module__}.{type(var_7).__qualname__}" == "centcount.CentCount"
    )
...
def test_case_31():
    ...
    assert var_1.centcount == 0
    assert var_1.currency == "USD"
    var_2 = cent_count_0.__gt__(var_0)
    assert var_2 is False
    ...
    var_8 = var_0.__le__(var_6)
    assert var_8 is True
    str_0 = "RhyY#In"
    cent_count_1 = module_0.CentCount(currency=str_0, strict_mode=str_0)
    assert (
        f"{type(cent_count_1).__module__}.{type(cent_count_1).__qualname__}"
        == "centcount.CentCount"
    )
    assert cent_count_1.strict_mode == "RhyY#In"
    assert cent_count_1.centcount == 0
    assert cent_count_1.currency == "RhyY#In"
    with pytest.raises(TypeError):
...
def test_case_32():
    ...
    assert var_3.centcount == 0
    assert var_3.currency == "USD"
    var_4 = cent_count_0.__ge__(var_2)
    assert var_4 is False
    var_5 = cent_count_0.__rsub__(var_1)
    assert (
        f"{type(var_5).__module__}.{type(var_5).__qualname__}" == "centcount.CentCount"
    )
    assert var_5.strict_mode is False
    ...
    var_7 = cent_count_0.__mul__(var_2)
    assert (
        f"{type(var_7).__module__}.{type(var_7).__qualname__}" == "centcount.CentCount"
    )
    assert var_7.strict_mode is False
    assert var_7.centcount == 0
    assert var_7.currency == "USD"
    var_8 = cent_count_0.__add__(var_6)
    assert (
        f"{type(var_8).__module__}.{type(var_8).__qualname__}" == "centcount.CentCount"
    )
    assert var_8.strict_mode is False
...
def test_case_33():
    ...
    var_3 = cent_count_0.__gt__(var_0)
    assert var_3 is False
    var_4 = cent_count_0.__le__(cent_count_0)
    assert var_4 is True
    var_5 = cent_count_0.__sub__(cent_count_0)
    assert (
        f"{type(var_5).__module__}.{type(var_5).__qualname__}" == "centcount.CentCount"
    )
    assert var_5.strict_mode is False
    assert var_5.centcount == 0
    assert var_5.currency == "USD"
    var_6 = cent_count_0.__eq__(var_0)
    assert var_6 is True
    var_7 = cent_count_0.__ge__(var_4)
    assert var_7 is False
    var_8 = cent_count_0.__rsub__(var_3)
    assert (
        f"{type(var_8).__module__}.{type(var_8).__qualname__}" == "centcount.CentCount"
    )
    assert var_8.strict_mode is False
    assert var_8.centcount == 0
    assert var_8.currency == "USD"
    var_9 = cent_count_0.__repr__()
    assert var_9 == "0.00 USD"
    var_10 = cent_count_0.__mul__(var_4)
    assert (
        f"{type(var_10).__module__}.{type(var_10).__qualname__}"
        == "centcount.CentCount"
    )
    ...
    assert var_10.centcount == 0
    assert var_10.currency == "USD"
    var_11 = cent_count_0.__add__(var_9)
    assert (
    ...
    var_12 = var_7.__int__()
    assert var_12 == 0
    var_13 = var_7.__bool__()
    assert var_13 is False
    var_14 = var_11.__le__(var_7)
    ...
    var_17 = cent_count_0.__eq__(cent_count_0)
    assert var_17 is True
    var_18 = var_9.__eq__(var_9)
    assert var_18 is True
    var_19 = cent_count_0.__neg__()
    assert (
        f"{type(var_19).__module__}.{type(var_19).__qualname__}"
        == "centcount.CentCount"
    )
    assert var_19.strict_mode is False
    assert var_19.centcount == 0
    assert var_19.currency == "USD"
    var_20 = var_10.__float__()
    assert var_20 == pytest.approx(0.0, abs=0.01, rel=0.01)
    var_21 = var_16.__ne__(cent_count_0)
    assert var_21 is False
    var_22 = var_14.__eq__(var_16)
    var_23 = module_1.escape(var_9)
    assert var_23 == "0\\.00\\ USD"
