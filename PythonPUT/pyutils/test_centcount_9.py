...
def test_case_6():
    ...
    var_4 = var_1.__mul__(cent_count_0)
    var_5 = cent_count_0.__le__(cent_count_0)
    assert var_5 is True
    var_6 = var_0.__add__(var_1)
...
def test_case_10():
    ...
    assert module_2.LC_CTYPE == 2
    assert module_2.LC_TIME == 5
    assert module_2.LC_COLLATE == 1
    assert module_2.LC_MONETARY == 3
    assert module_2.LC_NUMERIC == 4
    assert module_2.LC_ALL == 0
    assert module_2.CHAR_MAX == 127
    assert module_2.locale_encoding_alias == {
        "437": "C",
        "c": "C",
        "en": "ISO8859-1",
        "jis": "JIS7",
    ...
    assert module_2.k == "utf8"
    assert module_2.v == "UTF-8"
    assert module_2.locale_alias == {
        "a3": "az_AZ.KOI8-C",
        "a3_az": "az_AZ.KOI8-C",
    ...
    assert module_2.windows_locale == {
        1078: "af_ZA",
        1052: "sq_AL",
        1156: "gsw_FR",
        1118: "am_ET",
    ...
    str_0 = "hr(R#O0~'=As"
    cent_count_0 = module_0.CentCount(currency=str_0, strict_mode=error_0)
    assert (
        f"{type(cent_count_0).__module__}.{type(cent_count_0).__qualname__}"
        == "centcount.CentCount"
    )
    ...
    assert cent_count_0.centcount == 0
    assert cent_count_0.currency == "hr(R#O0~'=As"
    assert (
        f"{type(module_0.logger).__module__}.{type(module_0.logger).__qualname__}"
        == "logging.Logger"
    )
...
def test_case_12():
    ...
    error_0 = cent_count_0.__ne__(cent_count_0)
    assert error_0 is False
...
def test_case_14():
    ...
    none_type_0 = None
    with pytest.raises(TypeError):
        cent_count_1.__sub__(none_type_0)
...
def test_case_16():
    ...
    var_6 = var_5.__eq__(cent_count_0)
    cent_count_1 = module_0.CentCount(var_0, var_5)
    assert (
        f"{type(cent_count_1).__module__}.{type(cent_count_1).__qualname__}"
        == "centcount.CentCount"
    )
...
def test_case_17():
    ...
    str_0 = "~"
    none_type_0 = None
    cent_count_1 = module_0.CentCount(cent_count_0, str_0, strict_mode=none_type_0)
    assert (
        f"{type(cent_count_1).__module__}.{type(cent_count_1).__qualname__}"
        == "centcount.CentCount"
    )
    ...
    assert cent_count_1.currency == "~"
    cent_count_2 = module_0.CentCount(
        cent_count_1, none_type_0, strict_mode=none_type_0
    )
    assert (
    ...
    with pytest.raises(TypeError):
        cent_count_2.__lt__(cent_count_0)
...
def test_case_19():
    ...
    assert var_1.currency == "USD"
    var_2 = var_0.__lt__(bool_0)
    assert var_2 is False
    var_3 = var_2.__neg__()
    assert var_3 == 0
    var_4 = cent_count_1.__lt__(var_0)
    assert var_4 is False
    var_5 = cent_count_1.__le__(bool_0)
    assert var_5 is True
...
def test_case_21():
    ...
    var_1 = cent_count_0.__repr__()
    assert var_1 == "0.00 USD"
    var_2 = var_0.__gt__(cent_count_0)
    var_3 = cent_count_0.__neg__()
    assert (
        f"{type(var_3).__module__}.{type(var_3).__qualname__}" == "centcount.CentCount"
    )
    ...
    assert var_6.centcount == 0
    assert var_6.currency == "USD"
    var_7 = var_0.__ge__(var_5)
    var_8 = var_3.__add__(bool_0)
    assert (
        f"{type(var_8).__module__}.{type(var_8).__qualname__}" == "centcount.CentCount"
    )
    assert var_8.strict_mode is False
    ...
    var_10 = var_6.__truediv__(var_0)
    assert (
...
def test_case_23():
    ...
    var_4 = cent_count_2.__le__(var_0)
...
def test_case_24():
    ...
    assert var_4.centcount == 0
    assert var_4.currency == "USD"
    var_5 = cent_count_0.__rsub__(cent_count_0)
    assert (
        f"{type(var_5).__module__}.{type(var_5).__qualname__}" == "centcount.CentCount"
    )
    assert var_5.strict_mode is False
...
def test_case_25():
    ...
    assert var_0 is True
    var_0.__contains__(var_0, none_type_0)
...
def test_case_28():
    ...
    assert module_1.T == module_1.RegexFlag.TEMPLATE
    assert module_1.DEBUG == module_1.RegexFlag.DEBUG
    tuple_0 = (cent_count_0, var_0)
    cent_count_1 = module_0.CentCount(strict_mode=tuple_0)
    assert (
        f"{type(cent_count_1).__module__}.{type(cent_count_1).__qualname__}"
        == "centcount.CentCount"
    )
    ...
    assert len(cent_count_1.strict_mode) == 2
    assert cent_count_1.centcount == 0
    assert cent_count_1.currency == "USD"
    with pytest.raises(TypeError):
...
def test_case_29():
    ...
    var_0 = cent_count_0.__ge__(cent_count_0)
    assert var_0 is True
    var_1 = var_0.__gt__(cent_count_0)
...
def test_case_30():
    ...
    assert var_2.strict_mode is False
    assert var_2.centcount == 0
    assert var_2.currency == "0.00 USD"
    var_3 = cent_count_1.__lt__(bool_0)
    assert var_3 is True
    var_4 = cent_count_1.__sub__(var_1)
    assert (
        f"{type(var_4).__module__}.{type(var_4).__qualname__}" == "centcount.CentCount"
    )
    assert var_4.strict_mode is False
    assert var_4.centcount == 0
    assert var_4.currency == "0.00 USD"
    with pytest.raises(TypeError):
        var_4.__rsub__(cent_count_0)
...
def test_case_31():
    bool_0 = True
    none_type_0 = None
    cent_count_0 = module_0.CentCount(bool_0, none_type_0, strict_mode=none_type_0)
    assert (
        f"{type(cent_count_0).__module__}.{type(cent_count_0).__qualname__}"
        == "centcount.CentCount"
    )
