...
def test_case_5():
    ...
    assert var_4.currency == "USD"
    with pytest.raises(ValueError):
        module_0.CentCount(var_3, var_3)
...
def test_case_6():
    none_type_0 = None
    bool_0 = False
    cent_count_0 = module_0.CentCount(bool_0, none_type_0)
    assert (
        f"{type(cent_count_0).__module__}.{type(cent_count_0).__qualname__}"
        == "centcount.CentCount"
    )
    ...
    assert var_1.strict_mode is False
    assert var_1.centcount is False
...
def test_case_12():
    ...
    module_0.CentCount(exception_0)
...
def test_case_15():
    ...
    assert var_0.centcount == 0
    assert var_0.currency == "USD"
    var_1 = var_0.__ne__(cent_count_0)
    assert var_1 is False
    ...
    var_5 = var_2.__dir__()
    module_3.finditer(var_1, var_2, cent_count_0)
...
def test_case_18():
    ...
    assert var_4 is False
    var_5 = var_2.__dir__()
    var_6 = var_2.__mul__(cent_count_0)
    var_7 = cent_count_0.__ge__(var_1)
    assert var_7 is True
    var_8 = cent_count_0.__float__()
...
def test_case_23():
    ...
    assert var_5.currency == "USD"
    var_6 = var_4.__dir__()
    module_3.search(var_6, var_3, var_6)
...
def test_case_24():
    ...
    int_0 = var_0.__hash__()
    assert int_0 == 1
    var_1 = cent_count_0.__gt__(int_0)
    assert var_1 is False
    var_2 = cent_count_0.__ne__(var_0)
    assert var_2 is True
    var_3 = var_2.__le__(var_0)
    assert var_3 is True
    var_4 = cent_count_0.__sub__(var_0)
    assert (
        f"{type(var_4).__module__}.{type(var_4).__qualname__}" == "centcount.CentCount"
    )
    assert var_4.strict_mode is False
    ...
    assert var_5 == "-1.99 USD"
    var_6 = var_2.__repr__()
    assert var_6 == "True"
    var_7 = cent_count_0.__add__(var_2)
    assert (
    ...
    var_8 = var_4.__int__()
    assert var_8 == -1
    var_9 = var_0.__add__(var_0)
    assert var_9 == 2
    var_10 = cent_count_0.__ge__(var_8)
    ...
    assert cent_count_1.strict_mode is False
    assert cent_count_1.centcount == -199
    assert cent_count_1.currency == "USD"
    var_11 = var_2.__add__(bytes_0)
    var_12 = cent_count_0.__float__()
    assert var_12 == pytest.approx(0.0, abs=0.01, rel=0.01)
    var_13 = var_10.__ge__(var_5)
    var_14 = var_12.__eq__(var_13)
    var_15 = var_8.__gt__(var_8)
    assert var_15 is False
    var_16 = var_4.__rsub__(var_4)
    assert (
    ...
    var_3.__contains__(var_9, var_6)
...
def test_case_25():
    ...
    assert int_1 == -9223363241350014849
    ...
    assert cent_count_0.strict_mode is False
    assert cent_count_0.centcount == 1151
    assert cent_count_0.currency == 1151
    assert (
        f"{type(module_0.logger).__module__}.{type(module_0.logger).__qualname__}"
        == "logging.Logger"
    )
    ...
    assert var_1.strict_mode is False
    assert var_1.centcount == -1151
    assert var_1.currency == 1151
    var_2 = var_1.__truediv__(int_0)
    assert (
        f"{type(var_2).__module__}.{type(var_2).__qualname__}" == "centcount.CentCount"
    )
    assert var_2.strict_mode is False
    assert var_2.centcount == -1
    assert var_2.currency == 1151
...
def test_case_26():
    ...
    assert var_3.centcount == 0
    assert var_3.currency == "USD"
    error_0 = module_3.error(var_2, var_3)
    ...
    assert var_4.centcount == 0
    assert var_4.currency == "USD"
    var_5 = cent_count_0.__ge__(var_3)
    assert var_5 is True
...
def test_case_28():
    ...
    assert cent_count_0.strict_mode is False
    assert cent_count_0.centcount == -198907
    assert cent_count_0.currency == "USD"
    assert (
        f"{type(module_0.logger).__module__}.{type(module_0.logger).__qualname__}"
        == "logging.Logger"
    ...
    var_0 = cent_count_0.__eq__(float_0)
    assert var_0 is False
    var_1 = var_0.__rsub__(float_0)
    var_1.__reversed__(none_type_0)
...
def test_case_29():
    ...
    assert var_5.centcount == 0
    assert var_5.currency == "USD"
    cent_count_1 = module_0.CentCount(var_2, var_2)
    assert (
        f"{type(cent_count_1).__module__}.{type(cent_count_1).__qualname__}"
        == "centcount.CentCount"
    )
    ...
    var_6 = var_1.__sub__(var_5)
    set_0 = set()
    bool_0 = False
    cent_count_0.__call__(var_4, set_0, cent_count_0, type=bool_0)
...
def test_case_30():
    ...
    assert var_6 is True
    bytes_0 = b"\x11"
    var_7 = var_0.__add__(bytes_0)
    var_8 = cent_count_0.__float__()
    assert var_8 == pytest.approx(0.0, abs=0.01, rel=0.01)
    var_9 = var_6.__ge__(var_3)
    cent_count_1 = module_0.CentCount(currency=var_8)
    assert (
        f"{type(cent_count_1).__module__}.{type(cent_count_1).__qualname__}"
        == "centcount.CentCount"
    )
    ...
    var_10 = var_4.__gt__(cent_count_1)
    var_11 = var_1.__rsub__(var_1)
    assert (
    ...
    var_12 = var_10.__dir__()
    tuple_0 = (var_1, var_10, var_6, bytes_0)
    var_13 = var_10.__ne__(tuple_0)
    none_type_0 = None
    var_14 = cent_count_1.__repr__()
    assert var_14 == "$0.00"
    var_10.__mul__(none_type_0)
...
def test_case_31():
    ...
    assert var_4.centcount == -1
    assert var_4.currency == "USD"
    var_5 = cent_count_0.__add__(var_2)
    assert (
        f"{type(var_5).__module__}.{type(var_5).__qualname__}" == "centcount.CentCount"
    )
    assert var_5.strict_mode is False
    ...
    assert var_6 == 2
    var_7 = cent_count_0.__ge__(var_5)
    ...
    assert cent_count_1.currency == "USD"
    var_8 = var_2.__add__(bytes_0)
    var_9 = cent_count_0.__float__()
    assert var_9 == pytest.approx(0.0, abs=0.01, rel=0.01)
    var_10 = var_7.__ge__(var_3)
    ...
    assert cent_count_2.strict_mode is False
    assert cent_count_2.centcount == 0
    assert cent_count_2.currency is True
    var_11 = var_9.__eq__(var_10)
    assert var_11 is True
    var_12 = cent_count_2.__gt__(cent_count_2)
    assert var_12 is False
    var_3.__contains__(var_6, var_7)
...
def test_case_32():
    ...
    assert var_1.centcount == 0
    assert var_1.currency == "USD"
    var_2 = cent_count_0.__gt__(var_1)
    assert var_2 is False
    with pytest.raises(TypeError):
        var_0.__lt__(var_2)
...
def test_case_33():
    ...
    var_12 = cent_count_0.__lt__(var_0)
    assert var_12 is False
    var_13 = var_12.__ge__(var_4)
    assert var_13 is True
    var_14 = var_12.__rsub__(var_6)
    cent_count_1 = module_0.CentCount(var_6, var_13, strict_mode=var_1)
    assert (
        f"{type(cent_count_1).__module__}.{type(cent_count_1).__qualname__}"
        == "centcount.CentCount"
    )
    ...
    assert cent_count_1.centcount == 0
    assert cent_count_1.currency == "USD"
    cent_count_2 = module_0.CentCount(currency=var_10)
    assert (
        f"{type(cent_count_2).__module__}.{type(cent_count_2).__qualname__}"
        == "centcount.CentCount"
    )
    ...
    var_16 = var_12.__sub__(var_4)
    assert var_16 == 0
    cent_count_3 = module_0.CentCount(var_9, var_15)
    assert (
    ...
    var_17 = var_8.__eq__(var_7)
    var_18 = var_5.__pos__()
    assert var_18 == 0
    var_19 = var_7.__gt__(var_4)
    with pytest.raises(TypeError):
        cent_count_1.__rsub__(var_10)
...
def test_case_34():
    ...
    var_9 = cent_count_0.__ge__(var_7)
    assert var_9 is True
    var_10 = var_8.__repr__()
    assert var_10 == "0.00 USD"
    var_11 = cent_count_0.__lt__(var_0)
    assert var_11 is False
    var_12 = var_7.__rsub__(var_0)
    cent_count_1 = module_0.CentCount(var_10, strict_mode=var_0)
    assert (
        f"{type(cent_count_1).__module__}.{type(cent_count_1).__qualname__}"
        == "centcount.CentCount"
    )
    ...
    assert cent_count_1.centcount == 0
    assert cent_count_1.currency == "USD"
    str_0 = 'z"?pz]ws?aZb3?:\\@_ym'
    cent_count_2 = module_0.CentCount(strict_mode=str_0)
    assert (
        f"{type(cent_count_2).__module__}.{type(cent_count_2).__qualname__}"
        == "centcount.CentCount"
    )
    assert cent_count_2.strict_mode == 'z"?pz]ws?aZb3?:\\@_ym'
    assert cent_count_2.centcount == 0
    assert cent_count_2.currency == "USD"
    var_13 = var_3.__add__(var_3)
    assert var_13 == 0
    with pytest.raises(TypeError):
        cent_count_1.__sub__(var_9)
...
def test_case_35():
    ...
    var_7 = var_2.__int__()
    assert var_7 == 0
    var_8 = var_3.__add__(var_7)
    assert var_8 == 0
    var_9 = var_8.__ge__(cent_count_0)
    var_10 = var_5.__repr__()
    assert var_10 == "'0.00 USD'"
    var_11 = var_8.__lt__(var_8)
    assert var_11 is False
    var_12 = var_0.__ge__(var_1)
    assert var_12 is True
    var_13 = var_7.__rsub__(var_9)
    cent_count_1 = module_0.CentCount()
    assert (
        f"{type(cent_count_1).__module__}.{type(cent_count_1).__qualname__}"
        == "centcount.CentCount"
    ...
    assert cent_count_1.centcount == 0
    assert cent_count_1.currency == "USD"
    str_0 = "THPx{^VG-X]PQF~y-"
    int_0 = -1187
    cent_count_2 = module_0.CentCount(var_1, str_0, strict_mode=int_0)
    assert (
        f"{type(cent_count_2).__module__}.{type(cent_count_2).__qualname__}"
        == "centcount.CentCount"
    )
    assert cent_count_2.strict_mode == -1187
    assert cent_count_2.centcount == 0
    assert cent_count_2.currency == "THPx{^VG-X]PQF~y-"
    with pytest.raises(TypeError):
        cent_count_2.__add__(var_11)
...
def test_case_36():
    ...
    str_0 = "o})w]zw{OOA@C"
    cent_count_1 = module_0.CentCount(var_13, str_0)
    assert (
        f"{type(cent_count_1).__module__}.{type(cent_count_1).__qualname__}"
        == "centcount.CentCount"
    )
    assert cent_count_1.strict_mode is False
    assert cent_count_1.centcount == 0
    assert cent_count_1.currency == "o})w]zw{OOA@C"
    str_1 = "o|b\rt~L\niwPJ`MdGi\\eu"
    cent_count_2 = module_0.CentCount(currency=str_1)
    assert (
        f"{type(cent_count_2).__module__}.{type(cent_count_2).__qualname__}"
        == "centcount.CentCount"
    )
    assert cent_count_2.strict_mode is False
    assert cent_count_2.centcount == 0
    assert cent_count_2.currency == "o|b\rt~L\niwPJ`MdGi\\eu"
    with pytest.raises(TypeError):
...
def test_case_37():
    ...
    var_8 = var_1.__int__()
    assert var_8 == 0
    var_9 = cent_count_0.__add__(var_0)
    assert (
        f"{type(var_9).__module__}.{type(var_9).__qualname__}" == "centcount.CentCount"
    )
    assert var_9.strict_mode is False
    ...
    assert var_11 is False
    var_12 = var_6.__ge__(var_0)
    cent_count_1 = module_0.CentCount(currency=var_6, strict_mode=var_11)
    assert (
        f"{type(cent_count_1).__module__}.{type(cent_count_1).__qualname__}"
        == "centcount.CentCount"
    )
    ...
    var_13 = var_4.__add__(var_10)
    assert var_13 == 1
    var_14 = cent_count_2.__pos__()
    assert (
...
def test_case_38():
    ...
    var_12 = cent_count_0.__lt__(var_0)
    assert var_12 is False
    var_13 = var_8.__lt__(var_10)
    assert var_13 is True
    var_14 = var_10.__rsub__(var_7)
    cent_count_1 = module_0.CentCount()
    assert (
        f"{type(cent_count_1).__module__}.{type(cent_count_1).__qualname__}"
        == "centcount.CentCount"
    ...
    assert cent_count_1.currency == "USD"
    str_0 = "@TXIRMYiN.%"
    cent_count_2 = module_0.CentCount(var_13, str_0)
    assert (
        f"{type(cent_count_2).__module__}.{type(cent_count_2).__qualname__}"
        == "centcount.CentCount"
    )
    ...
    assert cent_count_2.currency == "@TXIRMYiN.%"
    var_15 = var_13.__bool__()
    assert var_15 is True
    var_16 = var_15.__add__(var_12)
    assert var_16 == 1
    var_17 = cent_count_0.__sub__(var_8)
    assert (
        f"{type(var_17).__module__}.{type(var_17).__qualname__}"
        == "centcount.CentCount"
    )
    assert var_17.strict_mode is False
    assert var_17.centcount == 0
    ...
    var_18 = var_3.__eq__(var_13)
    assert var_18 is False
    with pytest.raises(TypeError):
        cent_count_1.__gt__(cent_count_2)
