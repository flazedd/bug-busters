...
def test_case_4():
    ...
    assert cent_count_0.strict_mode is False
    assert cent_count_0.centcount == -40320
    assert cent_count_0.currency == "USD"
    assert (
        f"{type(module_0.logger).__module__}.{type(module_0.logger).__qualname__}"
        == "logging.Logger"
...
def test_case_5():
    ...
    cent_count_1 = module_0.CentCount(var_0, cent_count_0)
    assert (
...
def test_case_6():
    ...
    assert var_2 == "$0.00"
    cent_count_1 = module_0.CentCount(strict_mode=none_type_0)
    assert (
        f"{type(cent_count_1).__module__}.{type(cent_count_1).__qualname__}"
        == "centcount.CentCount"
    )
...
def test_case_9():
    ...
    var_0 = cent_count_0.__ge__(float_0)
...
def test_case_12():
    ...
    assert cent_count_0.strict_mode is False
    assert cent_count_0.centcount == 0
    assert cent_count_0.currency == "330C<Ma<{"
    assert (
        f"{type(module_0.logger).__module__}.{type(module_0.logger).__qualname__}"
        == "logging.Logger"
    )
...
def test_case_19():
    ...
    assert cent_count_0.strict_mode == "Q \x0cT\t"
    assert cent_count_0.centcount == 0
    assert cent_count_0.currency == "USD"
    assert (
        f"{type(module_0.logger).__module__}.{type(module_0.logger).__qualname__}"
...
def test_case_20():
    ...
    var_1 = var_0.__repr__()
    assert var_1 == "True"
    cent_count_1 = var_0.__gt__(cent_count_0)
...
def test_case_21():
    ...
    assert cent_count_0.strict_mode == "a$@5"
    assert cent_count_0.centcount == 0
    assert cent_count_0.currency == "USD"
    assert (
        f"{type(module_0.logger).__module__}.{type(module_0.logger).__qualname__}"
...
def test_case_23():
    ...
    assert cent_count_1.strict_mode is False
    assert cent_count_1.centcount == 0
    assert cent_count_1.currency == "g.D\x0cW`Py:Vi53:Yk_]"
    ...
    assert var_1.strict_mode is False
    assert var_1.centcount == 0
    assert var_1.currency == "g.D\x0cW`Py:Vi53:Yk_]"
    with pytest.raises(TypeError):
...
def test_case_24():
    ...
    assert cent_count_0.strict_mode == "330C\tc<Ma<{"
    assert cent_count_0.centcount == 0
    assert cent_count_0.currency == "USD"
    assert (
        f"{type(module_0.logger).__module__}.{type(module_0.logger).__qualname__}"
...
def test_case_27():
    ...
    assert cent_count_0.strict_mode == "330C\tc<Ma<{"
    assert cent_count_0.centcount == 0
    assert cent_count_0.currency == "330C\tc<Ma<{"
    assert (
        f"{type(module_0.logger).__module__}.{type(module_0.logger).__qualname__}"
        == "logging.Logger"
    )
    ...
    var_3 = cent_count_0.__add__(cent_count_0)
    assert (
    ...
    assert var_3.currency == "330C\tc<Ma<{"
...
def test_case_28():
    ...
    var_0 = module_0.CentCount(currency=str_0)
    assert (
        f"{type(var_0).__module__}.{type(var_0).__qualname__}" == "centcount.CentCount"
    )
    assert var_0.strict_mode is False
    assert var_0.centcount == 0
    assert var_0.currency == "330C\tc<Ma<{"
    var_1 = var_0.__repr__()
    assert var_1 == "0.00 330C\tc<Ma<{"
    with pytest.raises(TypeError):
        var_0.__add__(var_1)
...
def test_case_29():
    ...
    var_7 = cent_count_0.__ne__(var_6)
    ...
    var_9 = var_3.__gt__(var_5)
    var_10 = var_1.__add__(var_7)
    assert var_10 == 2
    var_11 = var_5.__le__(var_5)
    assert var_11 is True
    var_12 = var_10.__gt__(var_8)
    var_13 = var_4.__int__()
    assert var_13 == 0
    var_7.__setattr__(var_11, var_9, var_6)


@pytest.mark.xfail(strict=True)
def test_case_30():
    complex_0 = 239 - 2005.2j
    int_0 = 1594
    cent_count_0 = module_0.CentCount(int_0, strict_mode=complex_0)
    assert (
        f"{type(cent_count_0).__module__}.{type(cent_count_0).__qualname__}"
        == "centcount.CentCount"
    )
    assert cent_count_0.strict_mode == (239 - 2005.2j)
    assert cent_count_0.centcount == 1594
    assert cent_count_0.currency == "USD"
    assert (
        f"{type(module_0.logger).__module__}.{type(module_0.logger).__qualname__}"
        == "logging.Logger"
    ...
    assert var_1.strict_mode is False
    assert var_1.centcount == -1594
    assert var_1.currency == "USD"
    cent_count_0.__ne__(complex_0)
...
def test_case_31():
    ...
    cent_count_0 = module_0.CentCount(strict_mode=error_0)
    assert (
        f"{type(cent_count_0).__module__}.{type(cent_count_0).__qualname__}"
        == "centcount.CentCount"
    )
