...
def test_case_7():
    bytes_0 = b'\xb8"\x85\xb9r\x87\xc0\xf18:\xaa\x1d\xdcm)\x02\x0cy'
...
def test_case_9():
    int_0 = -306
    bool_0 = False
    money_0 = module_0.Money(bool_0, strict_mode=int_0)
    assert f"{type(money_0).__module__}.{type(money_0).__qualname__}" == "money.Money"
    assert money_0.strict_mode == -306
    assert (
        f"{type(money_0.amount).__module__}.{type(money_0.amount).__qualname__}"
        == "decimal.Decimal"
    )
...
def test_case_19():
    ...
    assert var_0.currency == "USD"
    module_3.finditer(money_0, var_0, var_0)
...
def test_case_26():
    ...
    assert var_1 is True
    module_3.match(var_1, money_0, var_1)
...
def test_case_27():
    ...
    var_6 = var_5.__ne__(var_0)
    assert var_6 is True
    module_4.EnumMeta(*var_2)
...
def test_case_28():
    ...
    assert var_3 == "0.00 USD"
    var_4 = money_0.__gt__(money_0)
    assert var_4 is False
    var_5 = var_1.__sub__(money_0)
    assert f"{type(var_5).__module__}.{type(var_5).__qualname__}" == "money.Money"
    assert var_5.strict_mode is False
    assert (
        f"{type(var_5.amount).__module__}.{type(var_5.amount).__qualname__}"
    ...
    assert var_9.currency == "USD"
    var_10 = var_1.__le__(var_6)
    assert var_10 is True
    int_0 = money_0.__hash__()
    var_11 = money_0.__float__()
    assert var_11 == pytest.approx(0.0, abs=0.01, rel=0.01)
    var_12 = var_1.__ge__(var_4)
    assert var_12 is True
    var_13 = var_1.__rsub__(var_9)
...
def test_case_30():
    ...
    var_8 = money_0.__gt__(money_0)
    assert var_8 is False
    int_0 = -3353
    var_9 = money_0.__ge__(int_0)
    assert var_9 is True
    var_10 = var_4.__sub__(money_0)
    ...
    var_11 = var_4.__le__(var_4)
    assert var_11 is True
    var_12 = var_8.__ne__(none_type_0)
    var_13 = var_4.__mul__(var_11)
    assert f"{type(var_13).__module__}.{type(var_13).__qualname__}" == "money.Money"
    assert var_13.strict_mode is False
    assert (
        f"{type(var_13.amount).__module__}.{type(var_13.amount).__qualname__}"
    ...
    var_16 = money_0.__float__()
    assert var_16 == pytest.approx(0.0, abs=0.01, rel=0.01)
    var_17 = var_4.__ge__(var_8)
    assert var_17 is True
    var_18 = var_4.__rsub__(var_15)
