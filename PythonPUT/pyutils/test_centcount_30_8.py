...
def test_case_3():
    ...
    bytes_0 = b"\x98\x9b\xcfO\\\xdc\xed\xa1"
    cent_count_1 = module_0.CentCount(currency=bytes_0)
    assert (
    ...
    assert cent_count_1.currency == b"\x98\x9b\xcfO\\\xdc\xed\xa1"
    module_1.sub(var_2, var_0, var_0, flags=int_0)
...
def test_case_5():
    ...
    assert var_0.centcount == 0
    assert var_0.currency == "USD"
    var_1 = var_0.__le__(bool_1)
    assert var_1 is True
    var_2 = var_1.__repr__()
    assert var_2 == "True"
    var_3 = var_2.__gt__(cent_count_0)
    var_4 = var_1.__add__(none_type_0)
...
def test_case_6():
    ...
    assert var_0.centcount == 0
    assert var_0.currency == "USD"
    var_1 = var_0.__ge__(cent_count_0)
    assert var_1 is True
...
def test_case_7():
    ...
    var_0 = cent_count_0.__le__(cent_count_0)
    assert var_0 is True
    var_0.__setattr__(var_0, cent_count_0, var_0)
...
def test_case_8():
    ...
    assert var_1.centcount == 0
    assert var_1.currency == "USD"
    cent_count_1 = module_0.CentCount(var_0, strict_mode=cent_count_0)
    assert (
        f"{type(cent_count_1).__module__}.{type(cent_count_1).__qualname__}"
        == "centcount.CentCount"
    )
    ...
    assert cent_count_1.currency == "USD"
    module_1.subn(cent_count_0, var_1, var_0)
...
def test_case_9():
    ...
    bool_0 = True
    var_0 = bool_0.__add__(bool_0)
    assert var_0 == 2
    bytes_0 = b"\x98\x9b\xcfO\\\xdc\xed\xa1"
    cent_count_1 = module_0.CentCount(cent_count_0, var_0, strict_mode=bool_0)
    assert (
        f"{type(cent_count_1).__module__}.{type(cent_count_1).__qualname__}"
        == "centcount.CentCount"
    )
    ...
    assert cent_count_1.centcount == 0
    assert cent_count_1.currency == 2
    module_1.sub(bool_0, cent_count_0, bytes_0, flags=bool_0)
...
def test_case_10():
    ...
    assert var_1.currency == "USD"
    bool_0 = True
    var_2 = cent_count_0.__ge__(bool_0)
    ...
    var_6 = var_4.__ne__(var_5)
    assert var_6 is True
    var_7 = cent_count_0.__neg__()
    assert (
    ...
    assert var_10 == "False"
    var_11 = cent_count_0.__sub__(var_0)
    assert (
    ...
    var_12 = var_0.__ne__(cent_count_0)
    var_13 = var_11.__repr__()
    assert var_13 == "-1.99 USD"
    str_0 = "\x0b@:Q~!/S;Y"
    var_14 = cent_count_0.__float__()
    assert var_14 == pytest.approx(0.0, abs=0.01, rel=0.01)
    var_11.__add__(str_0)
...
def test_case_13():
    ...
    assert cent_count_1.centcount == 0
    assert cent_count_1.currency == b"\x98\x9b\xcfO\\\xdc\xed\xa1"
    module_1.sub(var_1, var_0, var_0, flags=var_1)
...
def test_case_14():
    ...
    assert var_0 is True
    bool_0 = True
    var_1 = cent_count_0.__ge__(bool_0)
    ...
    assert var_6 == "True"
    var_7 = cent_count_0.__rsub__(var_4)
    assert (
        f"{type(var_7).__module__}.{type(var_7).__qualname__}" == "centcount.CentCount"
    )
    assert var_7.strict_mode is False
...
def test_case_15():
    ...
    assert cent_count_1.centcount == 0
    assert cent_count_1.currency == b"\x98\x9b\xcfO\\\xdc\xed\xa1"
    module_1.sub(var_5, var_0, var_0, flags=int_0)
...
def test_case_16():
    ...
    assert cent_count_1.strict_mode is False
    assert cent_count_1.centcount == 0
    assert cent_count_1.currency == "Ki@] \t$A!)S_74/Q/GOf"
    var_5 = var_2.__sub__(int_0)
    assert (
        f"{type(var_5).__module__}.{type(var_5).__qualname__}" == "centcount.CentCount"
    )
    assert var_5.strict_mode is False
...
def test_case_17():
    ...
    var_5 = var_2.__lt__(var_2)
    assert var_5 is False
    var_6 = var_3.__lt__(var_5)
    assert var_6 is False
    var_7 = var_4.__ne__(var_5)
    ...
    var_10 = cent_count_0.__sub__(var_1)
    assert (
    ...
    var_11 = var_1.__ne__(cent_count_0)
    var_12 = var_10.__repr__()
    assert var_12 == "-1.99 USD"
    var_13 = cent_count_0.__pos__()
    assert (
    ...
    str_0 = "\x0b@:Q~!/S;Y"
    var_14 = cent_count_0.__rsub__(var_7)
    assert (
    ...
    var_15 = cent_count_0.__float__()
    assert var_15 == pytest.approx(0.0, abs=0.01, rel=0.01)
    var_10.__add__(str_0)
...
def test_case_18():
    ...
    with pytest.raises(ValueError):
        module_0.CentCount(str_0, str_1)
...
def test_case_20():
    ...
    int_0 = var_0.__hash__()
    assert int_0 == 1
    var_3 = var_2.__add__(cent_count_0)
    assert (
...
def test_case_21():
    ...
    assert var_3.currency == "USD"
    with pytest.raises(TypeError):
        cent_count_0.__truediv__(var_3)
...
def test_case_22():
    ...
    assert cent_count_1.centcount == 0
    assert cent_count_1.currency == b"\x98\x9b\xcfO\\\xdc\xed\xa1"
    module_1.sub(var_4, var_3, var_1, flags=int_1)
...
def test_case_23():
    ...
    assert var_1.centcount == -1
    assert var_1.currency == "USD"
    var_2 = var_1.__sub__(cent_count_0)
    assert (
        f"{type(var_2).__module__}.{type(var_2).__qualname__}" == "centcount.CentCount"
    )
    assert var_2.strict_mode is False
...
def test_case_24():
    ...
    assert var_2 is False
    var_3 = var_1.__sub__(cent_count_0)
    assert (
        f"{type(var_3).__module__}.{type(var_3).__qualname__}" == "centcount.CentCount"
    )
    assert var_3.strict_mode is False
...
def test_case_25():
    ...
    assert var_2.centcount == 0
    assert var_2.currency == "USD"
    var_3 = cent_count_0.__gt__(var_1)
    assert var_3 is True
    var_4 = var_1.__gt__(cent_count_0)
    assert var_4 is False
    var_5 = var_4.__sub__(var_3)
    assert var_5 == -1
    var_6 = var_2.__ge__(var_5)
    assert var_6 is True
    var_7 = var_6.__repr__()
    assert var_7 == "True"
    var_8 = var_2.__float__()
    assert var_8 == pytest.approx(0.0, abs=0.01, rel=0.01)
    var_4.__contains__(var_6, var_6)
...
def test_case_27():
    ...
    int_0 = var_0.__hash__()
    assert int_0 == 0
    var_3 = var_2.__rsub__(int_0)
    assert var_3 == pytest.approx(0.0, abs=0.01, rel=0.01)
    with pytest.raises(TypeError):
        cent_count_1.__sub__(var_3)
...
def test_case_28():
    ...
    assert var_4.centcount == 0
    assert var_4.currency == "USD"
    var_5 = cent_count_0.__sub__(var_1)
    assert (
        f"{type(var_5).__module__}.{type(var_5).__qualname__}" == "centcount.CentCount"
    )
    assert var_5.strict_mode is False
    assert var_5.centcount == -1
    assert var_5.currency == "USD"
    var_6 = var_1.__ne__(cent_count_0)
    var_7 = var_5.__repr__()
    assert var_7 == "-1.99 USD"
    var_8 = cent_count_0.__float__()
    assert var_8 == pytest.approx(0.0, abs=0.01, rel=0.01)
...
def test_case_29():
    ...
    assert cent_count_1.currency == "USD"
    with pytest.raises(TypeError):
        cent_count_1.__lt__(none_type_0)
...
def test_case_30():
    ...
    var_12 = var_10.__repr__()
    assert var_12 == "-1.99 USD"
    var_13 = var_0.__rsub__(var_9)
    cent_count_1 = module_0.CentCount(currency=var_6)
    assert (
        f"{type(cent_count_1).__module__}.{type(cent_count_1).__qualname__}"
        == "centcount.CentCount"
    )
    ...
    var_14 = var_2.__float__()
    assert var_14 == pytest.approx(0.0, abs=0.01, rel=0.01)
    none_type_0 = None
    var_15 = var_1.__add__(none_type_0)
...
def test_case_31():
    ...
    assert var_4.centcount == -1
    assert var_4.currency == "USD"
    var_5 = var_1.__sub__(var_2)
    assert var_5 == 1
    var_6 = var_2.__lt__(var_2)
    assert var_6 is False
    var_7 = var_5.__lt__(cent_count_0)
    var_8 = var_6.__ne__(var_1)
    assert var_8 is True
    var_9 = var_1.__neg__()
    assert var_9 == -1
    var_10 = var_6.__ge__(var_0)
...
def test_case_32():
    ...
    var_3 = var_2.__neg__()
    assert var_3 == -1
    var_4 = var_0.__sub__(var_3)
    assert var_4 == 1
    var_5 = var_1.__sub__(cent_count_0)
    var_6 = var_1.__lt__(var_3)
    assert var_6 is False
    cent_count_1 = module_0.CentCount(strict_mode=var_4)
    assert (
        f"{type(cent_count_1).__module__}.{type(cent_count_1).__qualname__}"
        == "centcount.CentCount"
    )
    assert cent_count_1.strict_mode == 1
    assert cent_count_1.centcount == 0
    assert cent_count_1.currency == "USD"
    var_7 = cent_count_1.__mul__(var_1)
    assert (
        f"{type(var_7).__module__}.{type(var_7).__qualname__}" == "centcount.CentCount"
    )
    assert var_7.strict_mode is False
    assert var_7.centcount == 0
    assert var_7.currency == "USD"
    bytes_0 = b"\x1e\xbdnfb\xed\x9c\x1ff\xc6\xe3cmY\xf1\xb7B"
    cent_count_1.__ne__(bytes_0)


def test_case_33():
    none_type_0 = None
    bool_0 = True
    cent_count_0 = module_0.CentCount(bool_0, strict_mode=bool_0)
    assert (
        f"{type(cent_count_0).__module__}.{type(cent_count_0).__qualname__}"
        == "centcount.CentCount"
    )
...
def test_case_34():
    ...
    assert var_2 is True
    var_3 = cent_count_0.__ge__(var_1)
    assert var_3 is True
    var_4 = var_3.__neg__()
    assert var_4 == -1
    var_5 = cent_count_0.__sub__(var_2)
    assert (
        f"{type(var_5).__module__}.{type(var_5).__qualname__}" == "centcount.CentCount"
    )
    assert var_5.strict_mode is False
    assert var_5.centcount == -1
    assert var_5.currency == "USD"
    var_6 = var_3.__lt__(var_3)
    assert var_6 is False
    var_7 = var_4.__lt__(var_6)
    assert var_7 is True
    var_8 = var_5.__ne__(var_6)
    assert var_8 is True
    var_9 = cent_count_0.__neg__()
    assert (
        f"{type(var_9).__module__}.{type(var_9).__qualname__}" == "centcount.CentCount"
    )
    assert var_9.strict_mode is False
    ...
    assert var_9.currency == "USD"
    var_10 = var_6.__le__(var_4)
    assert var_10 is False
    var_11 = var_8.__ge__(var_7)
    assert var_11 is True
    var_12 = cent_count_0.__sub__(var_2)
    assert (
    ...
    var_13 = var_2.__ne__(cent_count_0)
    var_14 = var_12.__repr__()
    assert var_14 == "-1.99 USD"
    var_15 = var_0.__neg__()
    assert var_15 == 0
    var_16 = cent_count_0.__rsub__(cent_count_0)
    assert (
    ...
    var_17 = cent_count_0.__rsub__(var_8)
    assert (
    ...
    var_18 = var_9.__dir__()
    var_19 = var_6.__ne__(var_13)
    var_20 = var_7.__mul__(var_17)
    cent_count_1 = module_0.CentCount(currency=var_15)
    assert (
        f"{type(cent_count_1).__module__}.{type(cent_count_1).__qualname__}"
        == "centcount.CentCount"
    )
