...
def test_case_2():
    float_0 = 158.0
    cent_count_0 = module_0.CentCount(float_0, float_0)
    assert (
        f"{type(cent_count_0).__module__}.{type(cent_count_0).__qualname__}"
        == "centcount.CentCount"
    )
    assert cent_count_0.strict_mode is False
    assert cent_count_0.centcount == 15800
    assert cent_count_0.currency == pytest.approx(158.0, abs=0.01, rel=0.01)
    assert (
        f"{type(module_0.logger).__module__}.{type(module_0.logger).__qualname__}"
        == "logging.Logger"
    )
    ...
    assert var_0.centcount == -15800
    assert var_0.currency == pytest.approx(158.0, abs=0.01, rel=0.01)
    none_type_0 = None
...
def test_case_3():
    ...
    var_3 = cent_count_0.__rsub__(var_1)
    assert (
    ...
    var_4 = var_1.__rsub__(var_0)
    assert var_4 == pytest.approx(0.0, abs=0.01, rel=0.01)
    var_5 = var_4.__gt__(var_2)
    assert var_5 is False
    none_type_0 = None
    var_6 = var_3.__eq__(none_type_0)
    ...
    var_7 = var_4.__sub__(none_type_0)
...
def test_case_4():
    ...
    cent_count_1 = module_0.CentCount(currency=cent_count_0)
    assert (
        f"{type(cent_count_1).__module__}.{type(cent_count_1).__qualname__}"
        == "centcount.CentCount"
    )
...
def test_case_5():
    ...
    assert cent_count_0.strict_mode is False
    assert cent_count_0.centcount == 0
    assert cent_count_0.currency == "enTzV+I5M'nQFZ/_"
    assert (
        f"{type(module_0.logger).__module__}.{type(module_0.logger).__qualname__}"
        == "logging.Logger"
    )
...
def test_case_8():
    ...
    module_1.sub(cent_count_0, cent_count_0, cent_count_0)
...
def test_case_10():
    ...
    assert cent_count_1.centcount == 0
    assert cent_count_1.currency == "USD"
    var_1 = cent_count_1.__sub__(cent_count_1)
    assert (
...
def test_case_12():
    str_0 = "tQr-O0"
    str_1 = "enTzV+I5M'nQFZ/_"
    cent_count_0 = module_0.CentCount(currency=str_1)
    assert (
        f"{type(cent_count_0).__module__}.{type(cent_count_0).__qualname__}"
        == "centcount.CentCount"
    )
...
def test_case_13():
    ...
    assert cent_count_0.strict_mode == "@O6CM="
    assert cent_count_0.centcount == 0
    assert cent_count_0.currency == "USD"
    assert (
        f"{type(module_0.logger).__module__}.{type(module_0.logger).__qualname__}"
...
def test_case_16():
    ...
    none_type_0 = None
    cent_count_1 = module_0.CentCount(currency=var_0, strict_mode=none_type_0)
    assert (
        f"{type(cent_count_1).__module__}.{type(cent_count_1).__qualname__}"
        == "centcount.CentCount"
    )
    ...
    var_6 = var_1.__ge__(var_5)
    assert var_6 is True
    var_7 = cent_count_0.__pos__()
    assert (
...
def test_case_18():
    ...
    assert cent_count_0.strict_mode is False
    assert cent_count_0.centcount == 0
    assert cent_count_0.currency == "enTzVI5M'nQFZ/_"
    assert (
        f"{type(module_0.logger).__module__}.{type(module_0.logger).__qualname__}"
        == "logging.Logger"
    )
...
def test_case_22():
    ...
    assert cent_count_0.strict_mode is False
    assert cent_count_0.centcount == 0
    assert cent_count_0.currency == "tQr-O0"
    assert (
        f"{type(module_0.logger).__module__}.{type(module_0.logger).__qualname__}"
        == "logging.Logger"
    )
...
def test_case_23():
    ...
    assert var_1.strict_mode is False
    assert var_1.centcount == -1861
    assert var_1.currency == "USD"
    var_2 = var_0.__gt__(var_1)
    assert var_2 is True
    var_0.__delattr__(cent_count_0, var_1)
...
def test_case_27():
    ...
    assert int_0 == 8037537617361840934
    module_1.sub(cent_count_0, cent_count_0, cent_count_0)
...
def test_case_28():
    ...
    assert cent_count_0.strict_mode == "enTzV+I5M'nQFZ/_"
    assert cent_count_0.centcount == 0
    assert cent_count_0.currency == "USD"
    assert (
        f"{type(module_0.logger).__module__}.{type(module_0.logger).__qualname__}"
...
def test_case_29():
    ...
    assert cent_count_0.strict_mode is False
    assert cent_count_0.centcount == 0
    assert cent_count_0.currency == "bQ-50"
    assert (
        f"{type(module_0.logger).__module__}.{type(module_0.logger).__qualname__}"
        == "logging.Logger"
    )
...
def test_case_30():
    ...
    str_1 = "enTzV+I5M'nQFZ/_"
    str_2 = "@O6sM="
    cent_count_0 = module_0.CentCount(currency=str_2, strict_mode=str_0)
    assert (
        f"{type(cent_count_0).__module__}.{type(cent_count_0).__qualname__}"
        == "centcount.CentCount"
    )
    assert cent_count_0.strict_mode == "tQr-O0"
    assert cent_count_0.centcount == 0
    assert cent_count_0.currency == "@O6sM="
    assert (
        f"{type(module_0.logger).__module__}.{type(module_0.logger).__qualname__}"
        == "logging.Logger"
    )
...
def test_case_33():
    ...
    none_type_0 = None
    cent_count_2 = module_0.CentCount(currency=var_1, strict_mode=none_type_0)
    assert (
        f"{type(cent_count_2).__module__}.{type(cent_count_2).__qualname__}"
        == "centcount.CentCount"
    )
    assert cent_count_2.strict_mode is None
    assert cent_count_2.centcount == 0
    assert (
    ...
    var_8 = var_5.__rsub__(none_type_0)
    dict_0 = {cent_count_0: var_6}
    with pytest.raises(TypeError):
        var_3.__sub__(dict_0)
...
def test_case_34():
    ...
    var_2 = var_0.__gt__(var_1)
    assert var_2 is False
    var_3 = cent_count_0.__eq__(var_2)
    ...
    assert cent_count_1.centcount == 0
    assert cent_count_1.currency == "8-Han`P"
    with pytest.raises(TypeError):
...
def test_case_35():
    ...
    assert cent_count_1.centcount == 0
    assert cent_count_1.currency == "USD"
    var_4 = cent_count_1.__ne__(cent_count_1)
    assert var_4 is False
    var_5 = cent_count_0.__ne__(cent_count_1)
    assert var_5 is False
    cent_count_2 = module_0.CentCount()
    assert (
        f"{type(cent_count_2).__module__}.{type(cent_count_2).__qualname__}"
    ...
    assert var_6.currency == "USD"
    cent_count_3 = module_0.CentCount(var_2, var_1, strict_mode=var_3)
    assert (
        f"{type(cent_count_3).__module__}.{type(cent_count_3).__qualname__}"
        == "centcount.CentCount"
    )
    assert cent_count_3.strict_mode is False
    assert cent_count_3.centcount is False
    assert cent_count_3.currency is None
    var_7 = cent_count_2.__sub__(var_4)
    assert (
        f"{type(var_7).__module__}.{type(var_7).__qualname__}" == "centcount.CentCount"
    )
    assert var_7.strict_mode is False
    assert var_7.centcount == 0
    assert var_7.currency == "USD"
    var_8 = var_1.__ge__(var_3)
    assert var_8 is True
    cent_count_4 = module_0.CentCount(currency=var_8)
    assert (
        f"{type(cent_count_4).__module__}.{type(cent_count_4).__qualname__}"
        == "centcount.CentCount"
    )
    assert cent_count_4.strict_mode is False
    assert cent_count_4.centcount == 0
    assert cent_count_4.currency is True
    var_9 = module_2.object()
    with pytest.raises(TypeError):
        cent_count_3.__rsub__(cent_count_1)
...
def test_case_36():
    ...
    assert cent_count_3.centcount == 0
    assert cent_count_3.currency == "USD"
    var_7 = cent_count_3.__sub__(var_5)
    assert (
        f"{type(var_7).__module__}.{type(var_7).__qualname__}" == "centcount.CentCount"
    )
    assert var_7.strict_mode is False
    assert var_7.centcount == 0
    assert var_7.currency == "USD"
    var_8 = var_5.__ge__(var_3)
    assert var_8 is True
    cent_count_4 = module_0.CentCount()
    assert (
        f"{type(cent_count_4).__module__}.{type(cent_count_4).__qualname__}"
        == "centcount.CentCount"
    )
    assert cent_count_4.strict_mode is False
    assert cent_count_4.centcount == 0
    assert cent_count_4.currency == "USD"
    var_9 = cent_count_3.__ge__(cent_count_0)
    assert var_9 is True
    var_10 = cent_count_2.__rsub__(cent_count_3)
    assert (
    ...
    var_11 = var_3.__sub__(cent_count_4)
    var_12 = var_2.__gt__(var_7)
    var_13 = cent_count_2.__le__(cent_count_2)
    assert var_13 is True
    var_14 = var_5.__eq__(cent_count_1)
    var_15 = var_8.__repr__()
    assert var_15 == "True"
    var_16 = var_9.__neg__()
    assert var_16 == -1
    var_17 = var_6.__ge__(var_16)
    assert var_17 is True
    var_12.__rsub__(var_17)
...
def test_case_37():
    ...
    assert var_2 is False
    var_3 = var_2.__ne__(cent_count_0)
    cent_count_1 = module_0.CentCount()
    assert (
        f"{type(cent_count_1).__module__}.{type(cent_count_1).__qualname__}"
        == "centcount.CentCount"
    ...
    assert cent_count_1.centcount == 0
    assert cent_count_1.currency == "USD"
    var_4 = cent_count_1.__ne__(var_2)
    assert var_4 is False
    cent_count_2 = module_0.CentCount()
    assert (
        f"{type(cent_count_2).__module__}.{type(cent_count_2).__qualname__}"
    ...
    cent_count_4 = module_0.CentCount(cent_count_2, var_0, strict_mode=var_8)
    assert (
        f"{type(cent_count_4).__module__}.{type(cent_count_4).__qualname__}"
        == "centcount.CentCount"
    )
    assert (
        f"{type(cent_count_4.strict_mode).__module__}.{type(cent_count_4.strict_mode).__qualname__}"
        == "centcount.CentCount"
    )
    assert cent_count_4.centcount == 0
    assert cent_count_4.currency is None
    var_9 = var_5.__ge__(cent_count_4)
    with pytest.raises(TypeError):
        cent_count_4.__rsub__(var_3)
...
def test_case_38():
    ...
    assert var_5.centcount == 0
    assert var_5.currency == "USD"
    cent_count_3 = module_0.CentCount(cent_count_0)
    assert (
        f"{type(cent_count_3).__module__}.{type(cent_count_3).__qualname__}"
        == "centcount.CentCount"
    )
    ...
    assert cent_count_3.centcount == 0
    assert cent_count_3.currency == "USD"
    var_6 = var_1.__ge__(var_3)
    assert var_6 is True
    cent_count_4 = module_0.CentCount(currency=var_6)
    assert (
        f"{type(cent_count_4).__module__}.{type(cent_count_4).__qualname__}"
        == "centcount.CentCount"
    )
    ...
    assert cent_count_4.centcount == 0
    assert cent_count_4.currency is True
    var_7 = cent_count_3.__rsub__(cent_count_1)
    assert (
        f"{type(var_7).__module__}.{type(var_7).__qualname__}" == "centcount.CentCount"
    )
    assert var_7.strict_mode is False
    ...
    bytes_0 = b"\x95\xff\x8f"
    var_10 = var_8.__le__(var_6)
    assert var_10 is True
    cent_count_4.__eq__(bytes_0)
...
def test_case_39():
    ...
    assert var_3 is False
    var_4 = cent_count_0.__ne__(cent_count_1)
    assert var_4 is False
    cent_count_2 = module_0.CentCount()
    assert (
        f"{type(cent_count_2).__module__}.{type(cent_count_2).__qualname__}"
    ...
    assert var_5.centcount == 0
    assert var_5.currency == "USD"
    cent_count_3 = module_0.CentCount(var_1, strict_mode=cent_count_1)
    assert (
        f"{type(cent_count_3).__module__}.{type(cent_count_3).__qualname__}"
        == "centcount.CentCount"
    )
    ...
    assert cent_count_3.centcount == 0
    assert cent_count_3.currency == "USD"
    var_6 = cent_count_1.__sub__(var_2)
    assert (
        f"{type(var_6).__module__}.{type(var_6).__qualname__}" == "centcount.CentCount"
    )
    assert var_6.strict_mode is False
    ...
    var_7 = var_3.__neg__()
    assert var_7 == 0
    cent_count_4 = module_0.CentCount(currency=cent_count_1)
    assert (
        f"{type(cent_count_4).__module__}.{type(cent_count_4).__qualname__}"
        == "centcount.CentCount"
    )
    ...
    assert cent_count_4.centcount == 0
    assert (
        f"{type(cent_count_4.currency).__module__}.{type(cent_count_4.currency).__qualname__}"
        == "centcount.CentCount"
    )
    var_8 = var_0.__ge__(var_2)
    assert var_8 is True
    var_9 = cent_count_4.__rsub__(var_2)
    assert (
    ...
    assert (
        f"{type(var_9.currency).__module__}.{type(var_9.currency).__qualname__}"
        == "centcount.CentCount"
    )
    var_10 = var_0.__sub__(var_0)
    assert var_10 == 0
    with pytest.raises(TypeError):
        cent_count_3.__gt__(none_type_0)
