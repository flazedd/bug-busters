...
def test_case_5():
    ...
    assert cent_count_0.strict_mode == pytest.approx(2652.0, abs=0.01, rel=0.01)
    assert cent_count_0.centcount == 0
    assert cent_count_0.currency == "USD"
    assert (
        f"{type(module_0.logger).__module__}.{type(module_0.logger).__qualname__}"
...
def test_case_7():
    ...
    var_5 = cent_count_0.__gt__(int_0)
    assert var_5 is False
    cent_count_1 = module_0.CentCount(var_3, var_0, strict_mode=var_3)
    assert (
        f"{type(cent_count_1).__module__}.{type(cent_count_1).__qualname__}"
        == "centcount.CentCount"
    )
...
def test_case_8():
    ...
    var_1 = var_0.__dir__()
    with pytest.raises(TypeError):
        var_1.__setitem__(var_1, cent_count_0)
...
def test_case_9():
    ...
    assert var_4 == "0.01 USD"
    var_5 = var_4.__ne__(var_0)
    cent_count_1 = module_0.CentCount(var_4, strict_mode=var_2)
    assert (
        f"{type(cent_count_1).__module__}.{type(cent_count_1).__qualname__}"
        == "centcount.CentCount"
    )
...
def test_case_10():
    ...
    assert cent_count_1.centcount == 0
    assert cent_count_1.currency == "USD"
    var_0 = cent_count_1.__repr__()
    assert var_0 == "0.00 USD"
    var_1 = cent_count_1.__ge__(cent_count_0)
...
def test_case_14():
    ...
    assert var_2.strict_mode is False
    assert var_2.centcount == 2
    assert var_2.currency == "USD"
    var_2.__len__(cent_count_0)
...
def test_case_20():
    ...
    assert cent_count_0.strict_mode is False
    assert cent_count_0.centcount == 0
    assert cent_count_0.currency == "1>Z"
    assert (
        f"{type(module_0.logger).__module__}.{type(module_0.logger).__qualname__}"
        == "logging.Logger"
    )
    ...
    var_2 = cent_count_0.__ne__(bool_0)
    assert var_2 is False
...
def test_case_21():
    ...
    assert var_2.centcount == 0
    assert var_2.currency == "USD"
    var_3 = cent_count_0.__add__(var_0)
    assert (
        f"{type(var_3).__module__}.{type(var_3).__qualname__}" == "centcount.CentCount"
    )
    assert var_3.strict_mode is False
    ...
    assert var_5.centcount == 0
    assert var_5.currency == "USD"
    var_6 = var_4.__ne__(cent_count_0)
...
def test_case_22():
    ...
    with pytest.raises(ValueError):
        module_0.CentCount(var_5, strict_mode=var_3)
...
def test_case_25():
    ...
    assert var_2.centcount == 0
    assert var_2.currency == "USD"
    var_3 = cent_count_0.__rsub__(bool_0)
    assert (
        f"{type(var_3).__module__}.{type(var_3).__qualname__}" == "centcount.CentCount"
    )
    assert var_3.strict_mode is False
    ...
    assert var_4.centcount == 0
    assert var_4.currency == "USD"
    var_5 = cent_count_0.__float__()
    assert var_5 == pytest.approx(0.0, abs=0.01, rel=0.01)
    var_6 = var_5.__repr__()
    assert var_6 == "0.0"
    float_0 = -64.6
    cent_count_1 = module_0.CentCount(var_4, float_0, strict_mode=var_0)
    assert (
        f"{type(cent_count_1).__module__}.{type(cent_count_1).__qualname__}"
        == "centcount.CentCount"
    )
    assert cent_count_1.strict_mode is False
    assert cent_count_1.centcount == 0
    assert cent_count_1.currency == pytest.approx(-64.6, abs=0.01, rel=0.01)
    var_7 = var_5.__repr__()
    assert var_7 == "0.0"
    int_0 = -75
    cent_count_2 = module_0.CentCount(var_6, int_0)
    assert (
        f"{type(cent_count_2).__module__}.{type(cent_count_2).__qualname__}"
        == "centcount.CentCount"
    )
...
def test_case_27():
    ...
    assert var_3.centcount == 0
    assert var_3.currency == "USD"
    var_4 = var_0.__mul__(var_1)
    assert var_4 == 0
    var_5 = var_1.__neg__()
    assert var_5 == 0
    var_6 = cent_count_0.__add__(bool_0)
    assert (
...
def test_case_29():
    ...
    assert var_4.centcount == 0
    assert var_4.currency == "USD"
    var_5 = cent_count_0.__ge__(var_2)
    assert var_5 is False
    ...
    assert var_6.currency == "USD"
    var_7 = cent_count_0.__gt__(int_0)
    assert var_7 is False
    cent_count_1 = module_0.CentCount(var_2, int_0, strict_mode=var_2)
    assert (
        f"{type(cent_count_1).__module__}.{type(cent_count_1).__qualname__}"
        == "centcount.CentCount"
    )
    assert cent_count_1.strict_mode is True
    assert cent_count_1.centcount is True
    assert cent_count_1.currency == 1
    cent_count_2 = module_0.CentCount(var_6)
    assert (
        f"{type(cent_count_2).__module__}.{type(cent_count_2).__qualname__}"
        == "centcount.CentCount"
    )
...
def test_case_30():
    ...
    var_8 = var_3.__gt__(var_1)
    assert var_8 is False
    cent_count_1 = module_0.CentCount(currency=var_8, strict_mode=var_8)
    assert (
        f"{type(cent_count_1).__module__}.{type(cent_count_1).__qualname__}"
        == "centcount.CentCount"
    )
    ...
    assert cent_count_1.currency is None
    none_type_0 = None
    cent_count_2 = module_0.CentCount(currency=none_type_0)
    assert (
        f"{type(cent_count_2).__module__}.{type(cent_count_2).__qualname__}"
        == "centcount.CentCount"
    )
...
def test_case_31():
    ...
    var_4 = cent_count_0.__float__()
    assert var_4 == pytest.approx(0.0, abs=0.01, rel=0.01)
    var_5 = cent_count_0.__eq__(var_2)
    assert var_5 is False
    ...
    assert cent_count_1.centcount == 0
    assert cent_count_1.currency == "USD"
    cent_count_2 = module_0.CentCount(bool_0)
    assert (
        f"{type(cent_count_2).__module__}.{type(cent_count_2).__qualname__}"
        == "centcount.CentCount"
    )
    ...
    assert cent_count_2.currency == "USD"
    var_8 = var_0.__add__(var_7)
    var_9 = cent_count_0.__ne__(var_5)
...
def test_case_32():
    ...
    assert var_3 is True
    var_4 = cent_count_0.__le__(var_3)
    assert var_4 is True
    var_5 = var_4.__add__(var_2)
    assert var_5 == 1
    var_6 = var_3.__pos__()
    assert var_6 == 1
    var_7 = var_4.__ge__(var_0)
    assert var_7 is True
    var_8 = var_4.__sub__(var_1)
    assert var_8 == 0
    var_9 = var_1.__gt__(var_4)
    assert var_9 is False
    cent_count_1 = module_0.CentCount(currency=var_4, strict_mode=var_3)
    assert (
        f"{type(cent_count_1).__module__}.{type(cent_count_1).__qualname__}"
        == "centcount.CentCount"
    )
...
def test_case_33():
    ...
    var_4 = var_0.__add__(int_0)
    var_5 = var_2.__sub__(cent_count_0)
    assert (
        f"{type(var_5).__module__}.{type(var_5).__qualname__}" == "centcount.CentCount"
    )
    assert var_5.strict_mode is False
    assert var_5.centcount == 0
    assert var_5.currency == "USD"
    var_6 = int_1.__gt__(int_1)
    assert var_6 is False
    cent_count_1 = module_0.CentCount(strict_mode=var_2)
    assert (
        f"{type(cent_count_1).__module__}.{type(cent_count_1).__qualname__}"
        == "centcount.CentCount"
    )
    ...
    assert cent_count_1.currency == "USD"
    str_0 = "B(^^H$c"
    cent_count_2 = module_0.CentCount(var_6, str_0, strict_mode=int_1)
    assert (
        f"{type(cent_count_2).__module__}.{type(cent_count_2).__qualname__}"
        == "centcount.CentCount"
    )
    assert cent_count_2.centcount is False
    assert cent_count_2.currency == "B(^^H$c"
    regex_flag_0 = module_1.RegexFlag.VERBOSE
    with pytest.raises(TypeError):
        cent_count_2.__add__(regex_flag_0)
...
def test_case_34():
    ...
    assert var_5.centcount == 0
    assert var_5.currency == "USD"
    var_6 = var_0.__sub__(var_1)
    assert var_6 == -1
    var_7 = var_6.__pos__()
    assert var_7 == -1
    none_type_0 = None
    var_8 = var_4.__gt__(none_type_0)
    cent_count_1 = module_0.CentCount()
    assert (
        f"{type(cent_count_1).__module__}.{type(cent_count_1).__qualname__}"
        == "centcount.CentCount"
    ...
    assert cent_count_1.centcount == 0
    assert cent_count_1.currency == "USD"
    var_9 = var_8.__ne__(var_0)
    cent_count_2 = module_0.CentCount(strict_mode=int_0)
    assert (
        f"{type(cent_count_2).__module__}.{type(cent_count_2).__qualname__}"
        == "centcount.CentCount"
    )
...
def test_case_36():
    ...
    assert var_6.centcount == 0
    assert var_6.currency == "USD"
    var_7 = var_6.__sub__(cent_count_0)
    assert (
        f"{type(var_7).__module__}.{type(var_7).__qualname__}" == "centcount.CentCount"
    )
    assert var_7.strict_mode is False
    ...
    var_11 = cent_count_0.__mul__(var_0)
    assert (
    ...
    cent_count_2 = module_0.CentCount(var_8, strict_mode=var_6)
    assert (
        f"{type(cent_count_2).__module__}.{type(cent_count_2).__qualname__}"
        == "centcount.CentCount"
    )
    ...
    assert cent_count_2.centcount == 0
    assert cent_count_2.currency == "USD"
    var_12 = var_7.__ne__(var_9)
    assert var_12 is False
    var_13 = var_6.__repr__()
    assert var_13 == "0.00 USD"
    with pytest.raises(TypeError):
        cent_count_2.__lt__(var_1)
...
def test_case_37():
    ...
    assert var_6.centcount == 0
    assert var_6.currency == "USD"
    var_7 = var_1.__sub__(cent_count_0)
    ...
    assert var_8.currency == "USD"
    var_9 = var_1.__gt__(var_5)
    cent_count_1 = module_0.CentCount(strict_mode=var_3)
    assert (
        f"{type(cent_count_1).__module__}.{type(cent_count_1).__qualname__}"
        == "centcount.CentCount"
    )
