...
def test_case_3():
    ...
    assert cent_count_0.strict_mode is False
    assert cent_count_0.centcount == 0
    assert cent_count_0.currency == "[N"
    assert (
        f"{type(module_0.logger).__module__}.{type(module_0.logger).__qualname__}"
        == "logging.Logger"
    )
    ...
    str_1 = "*U6>rF5FsV`}[6L<PQ?f"
    var_5 = cent_count_0.__ge__(var_0)
    assert var_5 is True
    with pytest.raises(ValueError):
        module_0.CentCount(str_1)
...
def test_case_4():
    ...
    var_1 = tuple_0.__eq__(list_0)
    bool_0 = True
    var_2 = bool_0.__eq__(bool_0)
    ...
    var_3 = cent_count_0.__gt__(cent_count_0)
    assert var_3 is False
    var_4 = var_2.__sub__(tuple_0)
...
def test_case_6():
    ...
    bytes_0 = b"\x8d\x84\xf8N1\xc3.\xd5\xe4\xa4>\x9d"
...
def test_case_7():
    ...
    assert cent_count_0.strict_mode is False
    assert cent_count_0.centcount == 0
    assert cent_count_0.currency == "IN"
    assert (
        f"{type(module_0.logger).__module__}.{type(module_0.logger).__qualname__}"
        == "logging.Logger"
    )
    ...
    assert var_2.currency == "IN"
    cent_count_1 = module_0.CentCount(var_1, strict_mode=var_0)
    assert (
...
def test_case_12():
    ...
    assert cent_count_0.strict_mode is False
    assert cent_count_0.centcount == 0
    assert cent_count_0.currency == "xq;k|Rj}l$dA\\"
    assert (
        f"{type(module_0.logger).__module__}.{type(module_0.logger).__qualname__}"
        == "logging.Logger"
    )
    ...
    assert var_1.strict_mode is False
    assert var_1.centcount == 0
    assert var_1.currency == "xq;k|Rj}l$dA\\"
...
def test_case_16():
    ...
    cent_count_0.__truediv__(str_0)
...
def test_case_17():
    ...
    assert cent_count_0.strict_mode == "1N"
    assert cent_count_0.centcount == 0
    assert cent_count_0.currency == "USD"
    assert (
        f"{type(module_0.logger).__module__}.{type(module_0.logger).__qualname__}"
...
def test_case_21():
    ...
    assert cent_count_0.strict_mode is False
    assert cent_count_0.centcount == 0
    assert cent_count_0.currency == "1N"
    assert (
        f"{type(module_0.logger).__module__}.{type(module_0.logger).__qualname__}"
        == "logging.Logger"
    )
...
def test_case_27():
    ...
    assert var_2.currency == "xq;k|Rj}l$dA\\"
    var_3 = cent_count_0.__eq__(var_1)
    assert var_3 is False
    var_4 = cent_count_0.__le__(var_3)
    assert var_4 is True
    cent_count_1 = module_0.CentCount(var_1, var_1)
    assert (
        f"{type(cent_count_1).__module__}.{type(cent_count_1).__qualname__}"
        == "centcount.CentCount"
    )
    assert cent_count_1.strict_mode is False
    assert cent_count_1.centcount == 100
    assert cent_count_1.currency == pytest.approx(1.0, abs=0.01, rel=0.01)
...
def test_case_28():
    ...
    tuple_0 = (cent_count_0, var_1, str_0)
    with pytest.raises(TypeError):
        var_3.__rsub__(tuple_0)
...
def test_case_30():
    ...
    var_3 = cent_count_1.__ge__(cent_count_2)
    assert var_3 is True
...
def test_case_31():
    ...
    assert cent_count_1.strict_mode is False
    assert cent_count_1.centcount == 0
    assert cent_count_1.currency == "[N"
    var_0 = cent_count_0.__sub__(cent_count_0)
    assert (
        f"{type(var_0).__module__}.{type(var_0).__qualname__}" == "centcount.CentCount"
    )
    ...
    assert var_0.centcount == 0
    assert var_0.currency == "USD"
    var_1 = cent_count_1.__add__(cent_count_1)
    assert (
        f"{type(var_1).__module__}.{type(var_1).__qualname__}" == "centcount.CentCount"
    )
    assert var_1.strict_mode is False
...
def test_case_32():
    ...
    assert var_4.currency == "IN"
    cent_count_1 = module_0.CentCount(var_3, strict_mode=var_0)
    assert (
        f"{type(cent_count_1).__module__}.{type(cent_count_1).__qualname__}"
        == "centcount.CentCount"
    )
...
def test_case_33():
    ...
    assert cent_count_0.strict_mode == "x;k|R}l$A\\"
    assert cent_count_0.centcount == 0
    assert cent_count_0.currency == "x;k|R}l$A\\"
    assert (
        f"{type(module_0.logger).__module__}.{type(module_0.logger).__qualname__}"
        == "logging.Logger"
    )
...
def test_case_34():
    ...
    assert var_3.strict_mode is False
    assert var_3.centcount == 100
    assert var_3.currency == "xq;k|Rj}l$dA\\"
    var_4 = var_3.__ne__(var_0)
    assert var_4 is True
    var_5 = var_1.__le__(bool_0)
    assert var_5 is True
    var_6 = var_1.__gt__(cent_count_0)
    var_7 = var_6.__ne__(var_3)
    with pytest.raises(TypeError):
        var_3.__sub__(cent_count_1)
...
def test_case_36():
    ...
    assert cent_count_1.currency == "USD"
    bool_0 = True
    var_0 = module_0.CentCount(strict_mode=str_0)
    assert (
        f"{type(var_0).__module__}.{type(var_0).__qualname__}" == "centcount.CentCount"
    )
    assert var_0.strict_mode == "IN"
    assert var_0.centcount == 0
    assert var_0.currency == "USD"
...
def test_case_37():
    ...
    assert cent_count_0.strict_mode is False
    assert cent_count_0.centcount == 0
    assert cent_count_0.currency == "QcG{.X0C\nK\\$B\tnjGz5"
    assert (
        f"{type(module_0.logger).__module__}.{type(module_0.logger).__qualname__}"
        == "logging.Logger"
    )
