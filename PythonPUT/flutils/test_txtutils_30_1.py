...
def test_case_0():
    ...
    assert module_0.LC_CTYPE == 2
    assert module_0.LC_TIME == 5
    assert module_0.LC_COLLATE == 1
    assert module_0.LC_MONETARY == 3
    assert module_0.LC_NUMERIC == 4
    assert module_0.LC_ALL == 0
    assert module_0.CHAR_MAX == 127
    assert module_0.locale_encoding_alias == {
        "437": "C",
        "c": "C",
        "en": "ISO8859-1",
        "jis": "JIS7",
    ...
    assert module_0.k == "utf8"
    assert module_0.v == "UTF-8"
    assert module_0.locale_alias == {
        "a3": "az_AZ.KOI8-C",
        "a3_az": "az_AZ.KOI8-C",
    ...
    assert module_0.windows_locale == {
        1078: "af_ZA",
        1052: "sq_AL",
        1156: "gsw_FR",
        1118: "am_ET",
    ...
    ansi_text_wrapper_0 = module_1.AnsiTextWrapper(
        replace_whitespace=error_0, max_lines=error_0
    )
    assert (
    ...
    assert (
        f"{type(ansi_text_wrapper_0.replace_whitespace).__module__}.{type(ansi_text_wrapper_0.replace_whitespace).__qualname__}"
        == "locale.Error"
    )
    ...
    assert (
        f"{type(ansi_text_wrapper_0.max_lines).__module__}.{type(ansi_text_wrapper_0.max_lines).__qualname__}"
        == "locale.Error"
    )
    assert module_1.hexversion == 50987248
    assert (
        f"{type(module_1.AnsiTextWrapper.initial_indent).__module__}.{type(module_1.AnsiTextWrapper.initial_indent).__qualname__}"
        == "builtins.property"
    )
    assert (
        f"{type(module_1.AnsiTextWrapper.initial_indent_len).__module__}.{type(module_1.AnsiTextWrapper.initial_indent_len).__qualname__}"
        == "functools.cached_property"
    )
    assert module_1.AnsiTextWrapper.initial_indent_len.attrname == "initial_indent_len"
    assert (
        f"{type(module_1.AnsiTextWrapper.initial_indent_len.lock).__module__}.{type(module_1.AnsiTextWrapper.initial_indent_len.lock).__qualname__}"
        == "_thread.RLock"
    )
    assert (
        f"{type(module_1.AnsiTextWrapper.subsequent_indent).__module__}.{type(module_1.AnsiTextWrapper.subsequent_indent).__qualname__}"
        == "builtins.property"
    )
    assert (
        f"{type(module_1.AnsiTextWrapper.subsequent_indent_len).__module__}.{type(module_1.AnsiTextWrapper.subsequent_indent_len).__qualname__}"
        == "functools.cached_property"
    )
    assert (
        module_1.AnsiTextWrapper.subsequent_indent_len.attrname
        == "subsequent_indent_len"
    )
    assert (
        f"{type(module_1.AnsiTextWrapper.subsequent_indent_len.lock).__module__}.{type(module_1.AnsiTextWrapper.subsequent_indent_len.lock).__qualname__}"
        == "_thread.RLock"
    )
    assert (
        f"{type(module_1.AnsiTextWrapper.placeholder).__module__}.{type(module_1.AnsiTextWrapper.placeholder).__qualname__}"
        == "builtins.property"
    )
    assert (
        f"{type(module_1.AnsiTextWrapper.placeholder_len).__module__}.{type(module_1.AnsiTextWrapper.placeholder_len).__qualname__}"
        == "functools.cached_property"
    )
    assert module_1.AnsiTextWrapper.placeholder_len.attrname == "placeholder_len"
    assert (
        f"{type(module_1.AnsiTextWrapper.placeholder_len.lock).__module__}.{type(module_1.AnsiTextWrapper.placeholder_len.lock).__qualname__}"
        == "_thread.RLock"
    )
...
def test_case_1():
    ...
    bool_0 = False
    ansi_text_wrapper_0 = module_1.AnsiTextWrapper(
        fix_sentence_endings=bool_0, tabsize=bool_0, max_lines=bool_0
    )
    assert (
        f"{type(ansi_text_wrapper_0).__module__}.{type(ansi_text_wrapper_0).__qualname__}"
        == "txtutils.AnsiTextWrapper"
...
def test_case_4():
    int_0 = 1478
    str_0 = "5"
    ansi_text_wrapper_0 = module_1.AnsiTextWrapper(break_long_words=int_0)
    assert (
        f"{type(ansi_text_wrapper_0).__module__}.{type(ansi_text_wrapper_0).__qualname__}"
        == "txtutils.AnsiTextWrapper"
    )
    ...
    assert ansi_text_wrapper_0.replace_whitespace is True
    assert ansi_text_wrapper_0.fix_sentence_endings is False
    assert ansi_text_wrapper_0.break_long_words == 1478
    assert ansi_text_wrapper_0.drop_whitespace is True
    assert ansi_text_wrapper_0.break_on_hyphens is True
    assert ansi_text_wrapper_0.tabsize == 8
...
def test_case_6():
    ...
    bool_0 = True
    ansi_text_wrapper_0 = module_1.AnsiTextWrapper(bool_0)
    assert (
        f"{type(ansi_text_wrapper_0).__module__}.{type(ansi_text_wrapper_0).__qualname__}"
        == "txtutils.AnsiTextWrapper"
    )
...
def test_case_7():
    bool_0 = True
    ansi_text_wrapper_0 = module_1.AnsiTextWrapper(
        drop_whitespace=bool_0, break_on_hyphens=bool_0, placeholder=bool_0
    )
    assert (
        f"{type(ansi_text_wrapper_0).__module__}.{type(ansi_text_wrapper_0).__qualname__}"
        == "txtutils.AnsiTextWrapper"
    ...
    int_0 = 1484
    ansi_text_wrapper_1 = module_1.AnsiTextWrapper(
        subsequent_indent=ansi_text_wrapper_0, tabsize=int_0, max_lines=bool_0
    )
    assert (
    ...
    assert ansi_text_wrapper_1.tabsize == 1484
    assert ansi_text_wrapper_1.max_lines is True
    ansi_text_wrapper_2 = module_1.AnsiTextWrapper(break_long_words=int_0)
    assert (
    ...
    assert ansi_text_wrapper_2.break_long_words == 1484
...
def test_case_8():
    ...
    int_0 = 1478
    ansi_text_wrapper_1 = module_1.AnsiTextWrapper(
        subsequent_indent=str_0, tabsize=int_0, max_lines=bool_0
    )
    assert (
        f"{type(ansi_text_wrapper_1).__module__}.{type(ansi_text_wrapper_1).__qualname__}"
        == "txtutils.AnsiTextWrapper"
    ...
    assert ansi_text_wrapper_1.drop_whitespace is True
    assert ansi_text_wrapper_1.break_on_hyphens is True
    assert ansi_text_wrapper_1.tabsize == 1478
    ...
    assert ansi_text_wrapper_2.replace_whitespace is True
    assert ansi_text_wrapper_2.fix_sentence_endings is False
    assert ansi_text_wrapper_2.break_long_words == 1478
    assert ansi_text_wrapper_2.drop_whitespace is True
    assert ansi_text_wrapper_2.break_on_hyphens is True
    assert ansi_text_wrapper_2.tabsize == 8
    assert ansi_text_wrapper_2.max_lines is None
...
def test_case_9():
    ...
    int_0 = 1478
    ansi_text_wrapper_0 = module_1.AnsiTextWrapper(
        subsequent_indent=int_0, tabsize=int_0, max_lines=bool_0
    )
    assert (
        f"{type(ansi_text_wrapper_0).__module__}.{type(ansi_text_wrapper_0).__qualname__}"
        == "txtutils.AnsiTextWrapper"
    ...
    assert ansi_text_wrapper_0.drop_whitespace is True
    assert ansi_text_wrapper_0.break_on_hyphens is True
    assert ansi_text_wrapper_0.tabsize == 1478
    assert ansi_text_wrapper_0.max_lines is False
    assert module_1.hexversion == 50987248
    assert (
        f"{type(module_1.AnsiTextWrapper.initial_indent).__module__}.{type(module_1.AnsiTextWrapper.initial_indent).__qualname__}"
    ...
    int_1 = 1
    ansi_text_wrapper_1 = module_1.AnsiTextWrapper(break_long_words=int_1)
    assert (
        f"{type(ansi_text_wrapper_1).__module__}.{type(ansi_text_wrapper_1).__qualname__}"
        == "txtutils.AnsiTextWrapper"
    )
    ...
    assert ansi_text_wrapper_1.replace_whitespace is True
    assert ansi_text_wrapper_1.fix_sentence_endings is False
    assert ansi_text_wrapper_1.break_long_words == 1
    assert ansi_text_wrapper_1.drop_whitespace is True
    assert ansi_text_wrapper_1.break_on_hyphens is True
    assert ansi_text_wrapper_1.tabsize == 8
    assert ansi_text_wrapper_1.max_lines is None
    str_0 = "\r|=9Te)cXT[#wq\rhj@<"
    str_1 = ansi_text_wrapper_0.fill(str_0)
    assert str_1 == " |=9Te)cXT[#wq hj@<"
    module_2.finditer(str_0, ansi_text_wrapper_1, bool_0)
...
def test_case_10():
    ...
    ansi_text_wrapper_1 = module_1.AnsiTextWrapper(placeholder=str_0)
    assert (
        f"{type(ansi_text_wrapper_1).__module__}.{type(ansi_text_wrapper_1).__qualname__}"
        == "txtutils.AnsiTextWrapper"
    )
...
def test_case_11():
    ...
    assert ansi_text_wrapper_1.max_lines is False
    int_1 = 1
    ansi_text_wrapper_2 = module_1.AnsiTextWrapper(break_long_words=int_1)
    assert (
        f"{type(ansi_text_wrapper_2).__module__}.{type(ansi_text_wrapper_2).__qualname__}"
        == "txtutils.AnsiTextWrapper"
    )
    ...
    assert ansi_text_wrapper_2.replace_whitespace is True
    assert ansi_text_wrapper_2.fix_sentence_endings is False
    assert ansi_text_wrapper_2.break_long_words == 1
    assert ansi_text_wrapper_2.drop_whitespace is True
    assert ansi_text_wrapper_2.break_on_hyphens is True
    assert ansi_text_wrapper_2.tabsize == 8
    assert ansi_text_wrapper_2.max_lines is None
    str_1 = ansi_text_wrapper_2.fill(str_0)
    assert str_1 == "w9g3zgCy"
    str_2 = "\r|=9Te)cXT[#wq\rhj@<"
    str_3 = ansi_text_wrapper_0.fill(str_2)
    assert str_3 == " |=9Te)cXT[#wq hj@<"
    list_0 = ansi_text_wrapper_1.wrap(str_0)
...
def test_case_12():
    ...
    bool_2 = True
    bool_3 = False
    module_2.split(bool_2, bool_3, bool_1)
...
def test_case_13():
    ...
    int_1 = -2940
    ansi_text_wrapper_0 = module_1.AnsiTextWrapper(
        subsequent_indent=str_0, tabsize=int_0, max_lines=int_1
    )
    assert (
        f"{type(ansi_text_wrapper_0).__module__}.{type(ansi_text_wrapper_0).__qualname__}"
        == "txtutils.AnsiTextWrapper"
    ...
    assert ansi_text_wrapper_0.break_on_hyphens is True
    assert ansi_text_wrapper_0.tabsize == 1478
    assert ansi_text_wrapper_0.max_lines == -2940
    assert module_1.hexversion == 50987248
    assert (
        f"{type(module_1.AnsiTextWrapper.initial_indent).__module__}.{type(module_1.AnsiTextWrapper.initial_indent).__qualname__}"
        == "builtins.property"
    ...
    assert ansi_text_wrapper_1.replace_whitespace is True
    assert ansi_text_wrapper_1.fix_sentence_endings is False
    assert ansi_text_wrapper_1.break_long_words == 924
    assert ansi_text_wrapper_1.drop_whitespace is False
    assert ansi_text_wrapper_1.break_on_hyphens is True
    assert ansi_text_wrapper_1.tabsize == 8
    assert ansi_text_wrapper_1.max_lines == -2940
    str_1 = "eutf8h"
...
def test_case_14():
    ...
    assert ansi_text_wrapper_1.tabsize == 1478
    assert ansi_text_wrapper_1.max_lines is True
    str_0 = "o)\rD;EJhoh=lCQwao%"
    str_1 = ansi_text_wrapper_1.fill(str_0)
    assert str_1 == "o) D;EJhoh=lCQwao%"
    int_1 = 912
    ansi_text_wrapper_2 = module_1.AnsiTextWrapper(break_long_words=int_1)
    assert (
        f"{type(ansi_text_wrapper_2).__module__}.{type(ansi_text_wrapper_2).__qualname__}"
    ...
    assert ansi_text_wrapper_2.replace_whitespace is True
    assert ansi_text_wrapper_2.fix_sentence_endings is False
    assert ansi_text_wrapper_2.break_long_words == 912
    assert ansi_text_wrapper_2.drop_whitespace is True
    assert ansi_text_wrapper_2.break_on_hyphens is True
    assert ansi_text_wrapper_2.tabsize == 8
    assert ansi_text_wrapper_2.max_lines is None
    ...
    str_4 = '"Tl]UR(}'
    str_5 = "?<_JsEs[]F%^"
    ansi_text_wrapper_3 = module_1.AnsiTextWrapper(
        bool_0,
        str_4,
        str_2,
    ...
    assert ansi_text_wrapper_3.max_lines == 1478
...
def test_case_15():
    ...
    int_0 = 1478
    ansi_text_wrapper_1 = module_1.AnsiTextWrapper(
        subsequent_indent=str_0, tabsize=int_0, max_lines=int_0
    )
    assert (
        f"{type(ansi_text_wrapper_1).__module__}.{type(ansi_text_wrapper_1).__qualname__}"
        == "txtutils.AnsiTextWrapper"
    ...
    assert ansi_text_wrapper_1.break_on_hyphens is True
    assert ansi_text_wrapper_1.tabsize == 1478
    assert ansi_text_wrapper_1.max_lines == 1478
    str_1 = "H"
    ...
    none_type_0 = None
    str_4 = '"BPG\tzte;JbbPZL(jI'
    str_5 = ansi_text_wrapper_1.fill(str_0)
    assert str_5 == "w9g3zgCy"
    list_2 = ansi_text_wrapper_1.wrap(str_4)
    module_2.template(none_type_0, list_0)
...
def test_case_16():
    str_0 = ""
    list_0 = [str_0, str_0]
    int_0 = module_1.len_without_ansi(list_0)
    assert int_0 == 0
    assert module_1.hexversion == 50987248
...
def test_case_17():
    ...
    assert str_1 == "H"
    str_2 = "_~M\t"
    ansi_text_wrapper_1.wrap(str_2)
...
def test_case_18():
    ...
    assert ansi_text_wrapper_1.tabsize == 1478
    assert ansi_text_wrapper_1.max_lines is True
    str_0 = "n!`el(2o\r~)d!VFgc"
    str_1 = ansi_text_wrapper_1.fill(str_0)
    assert str_1 == "n!`el(2o ~)d!VFgc"
    str_2 = "H"
    str_3 = ansi_text_wrapper_1.fill(str_0)
    assert str_3 == "n!`el(2o ~)d!VFgc"
    int_1 = 912
    ansi_text_wrapper_2 = module_1.AnsiTextWrapper(break_long_words=int_1)
    assert (
        f"{type(ansi_text_wrapper_2).__module__}.{type(ansi_text_wrapper_2).__qualname__}"
    ...
    assert ansi_text_wrapper_2.tabsize == 8
    assert ansi_text_wrapper_2.max_lines is None
    str_4 = ansi_text_wrapper_2.fill(str_2)
    assert str_4 == "H"
