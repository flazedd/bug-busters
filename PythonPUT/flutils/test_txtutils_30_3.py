...
def test_case_6():
    ...
    str_0 = "7XERxE\ttK]"
    ansi_text_wrapper_1 = module_0.AnsiTextWrapper(expand_tabs=str_0)
    assert (
        f"{type(ansi_text_wrapper_1).__module__}.{type(ansi_text_wrapper_1).__qualname__}"
        == "txtutils.AnsiTextWrapper"
    )
    assert ansi_text_wrapper_1.width == 70
    assert ansi_text_wrapper_1.expand_tabs == "7XERxE\ttK]"
    ...
    assert ansi_text_wrapper_2.replace_whitespace == "7XERxE\ttK]"
    ...
    assert ansi_text_wrapper_2.max_lines == []
