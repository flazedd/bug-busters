...
def test_case_0():
    ...
    assert var_0 == "8-9-5--2-9"
    var_1 = module_0.snakecase(float_0)
    assert var_1 == "8_9_5__2_9"
    var_2 = module_0.camelcase(float_0)
    assert var_2 == "89529"
...
def test_case_2():
    ...
    assert var_1 == "8_0_2"
    var_2 = module_0.spinalcase(var_0)
    assert var_2 == "8-0-2"
    var_3 = module_0.pascalcase(var_1)
    assert var_3 == "802"
    var_4 = module_0.camelcase(var_3)
    assert var_4 == "802"
    var_5 = module_0.camelcase(int_0)
    assert var_5 == "802"
...
def test_case_3():
    ...
    var_2 = module_0.spinalcase(var_0)
    assert var_2 == "8-0-2"
    var_3 = module_1.template(var_1)
    assert f"{type(var_3).__module__}.{type(var_3).__qualname__}" == "re.Pattern"
    ...
    assert var_4 == "ReCompile('802',Re.TEMPLATE)"
    var_5 = module_0.capitalcase(var_1)
    assert var_5 == "8_0_2"
    ...
    var_6 = module_0.capitalcase(error_0)
    assert var_6 == ""
    var_7 = module_0.camelcase(var_3)
    assert var_7 == "reCompile('802',Re.TEMPLATE)"
    var_8 = module_0.snakecase(var_0)
    assert var_8 == "8_0_2"
    var_9 = module_0.camelcase(error_0)
    assert var_9 == ""
...
def test_case_4():
    ...
    assert var_0 == ""
    var_1 = module_0.camelcase(str_0)
    assert var_1 == ""
    var_0.__getitem__(var_1, var_0)
