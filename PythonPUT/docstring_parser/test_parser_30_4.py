...
def test_case_0():
    ...
    assert docstring_0.short_description == "p&/v57"
...
def test_case_3():
    ...
    bool_0 = False
    docstring_1 = module_0.parse(bool_0)
    assert (
...
def test_case_5():
    str_0 = ":wSb/H+#}b<dx.S.~O|S"
    docstring_0 = module_0.parse(str_0)
    assert (
        f"{type(docstring_0).__module__}.{type(docstring_0).__qualname__}"
        == "docstring_parser.common.Docstring"
    )
    assert docstring_0.short_description == ":wSb/H+#}b<dx.S.~O|S"
    assert docstring_0.long_description is None
    assert docstring_0.blank_after_short_description is False
    assert docstring_0.blank_after_long_description is False
    assert docstring_0.meta == []
...
def test_case_6():
    ...
    assert (
        ...
        == "(|rf|U|f|b|br|Br|rF|fr|fR|RF|BR|rB|FR|Rf|rb|r|R|RB|Rb|B|F|u|bR|Fr)"
    )
    ...
    assert (
        module_2.Triple
        == "((|rf|U|f|b|br|Br|rF|fr|fR|RF|BR|rB|FR|Rf|rb|r|R|RB|Rb|B|F|u|bR|Fr)'''|(|rf|U|f|b|br|Br|rF|fr|fR|RF|BR|rB|FR|Rf|rb|r|R|RB|Rb|B|F|u|bR|Fr)\"\"\")"
    )
    assert (
        module_2.String
        == "((|rf|U|f|b|br|Br|rF|fr|fR|RF|BR|rB|FR|Rf|rb|r|R|RB|Rb|B|F|u|bR|Fr)'[^\\n'\\\\]*(?:\\\\.[^\\n'\\\\]*)*'|(|rf|U|f|b|br|Br|rF|fr|fR|RF|BR|rB|FR|Rf|rb|r|R|RB|Rb|B|F|u|bR|Fr)\"[^\\n\"\\\\]*(?:\\\\.[^\\n\"\\\\]*)*\")"
    ...
    assert (
        ...
        == "[ \\f\\t]*((\\\\\\r?\\n|\\Z|#[^\\r\\n]*|((|rf|U|f|b|br|Br|rF|fr|fR|RF|BR|rB|FR|Rf|rb|r|R|RB|Rb|B|F|u|bR|Fr)'''|(|rf|U|f|b|br|Br|rF|fr|fR|RF|BR|rB|FR|Rf|rb|r|R|RB|Rb|B|F|u|bR|Fr)\"\"\"))|(([0-9](?:_?[0-9])*[jJ]|(([0-9](?:_?[0-9])*\\.(?:[0-9](?:_?[0-9])*)?|\\.[0-9](?:_?[0-9])*)([eE][-+]?[0-9](?:_?[0-9])*)?|[0-9](?:_?[0-9])*[eE][-+]?[0-9](?:_?[0-9])*)[jJ])|(([0-9](?:_?[0-9])*\\.(?:[0-9](?:_?[0-9])*)?|\\.[0-9](?:_?[0-9])*)([eE][-+]?[0-9](?:_?[0-9])*)?|[0-9](?:_?[0-9])*[eE][-+]?[0-9](?:_?[0-9])*)|(0[xX](?:_?[0-9a-fA-F])+|0[bB](?:_?[01])+|0[oO](?:_?[0-7])+|(?:0(?:_?0)*|[1-9](?:_?[0-9])*)))|(\\r?\\n|(\\~|\\}|\\|=|\\||\\{|\\^=|\\^|\\]|\\[|@=|@|>>=|>>|>=|>|==|=|<=|<<=|<<|<|;|:=|:|/=|//=|//|/|\\.\\.\\.|\\.|\\->|\\-=|\\-|,|\\+=|\\+|\\*=|\\*\\*=|\\*\\*|\\*|\\)|\\(|\\&=|\\&|%=|%|!=))|((|rf|U|f|b|br|Br|rF|fr|fR|RF|BR|rB|FR|Rf|rb|r|R|RB|Rb|B|F|u|bR|Fr)'[^\\n'\\\\]*(?:\\\\.[^\\n'\\\\]*)*('|\\\\\\r?\\n)|(|rf|U|f|b|br|Br|rF|fr|fR|RF|BR|rB|FR|Rf|rb|r|R|RB|Rb|B|F|u|bR|Fr)\"[^\\n\"\\\\]*(?:\\\\.[^\\n\"\\\\]*)*(\"|\\\\\\r?\\n))|\\w+)"
    )
    ...
    assert module_2.t == "Fr"
    assert module_2.u == "Fr'''"
