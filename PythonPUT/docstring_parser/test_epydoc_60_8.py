...
def test_case_0():
    ...
    assert docstring_0.short_description == ";W_"
...
def test_case_2():
    ...
    assert docstring_0.short_description == "==4"
    assert docstring_0.long_description == "SNT]V6\nj"
    assert docstring_0.blank_after_short_description is False
    assert docstring_0.blank_after_long_description is False
    assert docstring_0.meta == []
    assert docstring_0.style == module_1.DocstringStyle.EPYDOC
...
def test_case_7():
    ...
    assert docstring_1.short_description == "==4"
    assert docstring_1.long_description == "ST]V6\nj"
    ...
    assert docstring_2.long_description == "ST]V6\nj"
