...
public class Queue_ESTest_11 {

  @Test
  public void test00()  throws Throwable  {
      Queue queue0 = new Queue((-1535));
  ...
  public void test02()  throws Throwable  {
      ...
      queue0.enqueue(queue_Node0);
      int int0 = queue0.remove(queue_Node0);
      assertEquals((-1), queue0.getNumberItems());
      assertEquals(1, int0);
  }
...
//      assertEquals("bible.util.Queue:[numItems=0, maxNumItems=0, maxCapacity=0, getObjects()=[]\r\n]", string0);
//  }
}
