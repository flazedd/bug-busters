...
public class Queue_ESTest_7 {
  ...
  public void test02()  throws Throwable  {
      ...
      int int0 = queue0.remove("bible.util.Queue:[numItems=0, maxNumItems=0, maxCapacity=-1, getObjects()=[]\r\n]");
  ...
  public void test24()  throws Throwable  {
      Queue queue0 = new Queue();
      queue0.refreshElement("bible.util.Queue:[numItems=0, maxNumItems=0, maxCapacity=-1, getObjects()=[]\r\n]");
      queue0.remove("bible.util.Queue:[numItems=0, maxNumItems=0, maxCapacity=-1, getObjects()=[]\r\n]");
      Object object0 = new Object();
      queue0.enqueue(object0);
      assertEquals(1, queue0.getNumberItems());
  }
