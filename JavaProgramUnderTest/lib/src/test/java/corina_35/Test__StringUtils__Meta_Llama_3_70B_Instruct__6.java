...
public class Test__StringUtils__Meta_Llama_3_70B_Instruct__6 {
@Test
...
@Test
public void testLeftPadWithLongerString() {
    assertEquals("abcde", StringUtils.leftPad("abcde", 5));
}
@Test
...
@Test
public void testEscapeForXMLWithQuotes() {
    String input = "Hello \"world\"";
    String expected = "Hello &quot;world&quot;";
    assertEquals(expected, StringUtils.escapeForXML(input));
}
