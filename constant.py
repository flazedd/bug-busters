...
# Choose 3 for: mistralai/Mixtral-8x7B-Instruct-v0.1
# Choose 4 for: NousResearch/Nous-Hermes-2-Mixtral-8x7B-DPO
# Choose 5 for: 01-ai/Yi-1.5-34B-Chat
# Choose 6 for: google/gemma-1.1-7b-it
# Choose 7 for: mistralai/Mistral-7B-Instruct-v0.2
# Choose 8 for: microsoft/Phi-3-mini-4k-instruct